...
asn_TYPE_descriptor_t asn_DEF_supportedCodebookMode_12 = {
	...
	{ 0, &asn_PER_type_supportedCodebookMode_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_DummyB_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyB, maxNumberResources),
		...
		0,
		{ 0, &asn_PER_memb_maxNumberResources_constr_10,  memb_maxNumberResources_constraint_1 },
		0, 0, /* No default value */
		"maxNumberResources"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct DummyB, totalNumberTxPorts),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_totalNumberTxPorts_constr_11,  memb_totalNumberTxPorts_constraint_1 },
		0, 0, /* No default value */
		"totalNumberTxPorts"
		},
