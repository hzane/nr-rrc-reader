...
asn_TYPE_descriptor_t asn_DEF_dl_UL_TransmissionPeriodicity_2 = {
	...
	{ 0, &asn_PER_type_dl_UL_TransmissionPeriodicity_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_dl_UL_TransmissionPeriodicity_v1530_17 = {
	...
	{ 0, &asn_PER_type_dl_UL_TransmissionPeriodicity_v1530_constr_17, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_TDD_UL_DL_Pattern_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TDD_UL_DL_Pattern, nrofDownlinkSlots),
		...
		0,
		{ 0, &asn_PER_memb_nrofDownlinkSlots_constr_11,  memb_nrofDownlinkSlots_constraint_1 },
		0, 0, /* No default value */
		"nrofDownlinkSlots"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct TDD_UL_DL_Pattern, nrofDownlinkSymbols),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_nrofDownlinkSymbols_constr_12,  memb_nrofDownlinkSymbols_constraint_1 },
		0, 0, /* No default value */
		"nrofDownlinkSymbols"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct TDD_UL_DL_Pattern, nrofUplinkSlots),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_nrofUplinkSlots_constr_13,  memb_nrofUplinkSlots_constraint_1 },
		0, 0, /* No default value */
		"nrofUplinkSlots"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct TDD_UL_DL_Pattern, nrofUplinkSymbols),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_nrofUplinkSymbols_constr_14,  memb_nrofUplinkSymbols_constraint_1 },
		0, 0, /* No default value */
		"nrofUplinkSymbols"
		},
