...
asn_TYPE_member_t asn_MBR_IntraFreqNeighCellInfo_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct IntraFreqNeighCellInfo, q_RxLevMinOffsetCell),
		...
		0,
		{ 0, &asn_PER_memb_q_RxLevMinOffsetCell_constr_4,  memb_q_RxLevMinOffsetCell_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct IntraFreqNeighCellInfo, q_RxLevMinOffsetCellSUL),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_q_RxLevMinOffsetCellSUL_constr_5,  memb_q_RxLevMinOffsetCellSUL_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct IntraFreqNeighCellInfo, q_QualMinOffsetCell),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_q_QualMinOffsetCell_constr_6,  memb_q_QualMinOffsetCell_constraint_1 },
		0, 0, /* No default value */
		"q-QualMinOffsetCell"
		},
};
