...
asn_TYPE_descriptor_t asn_DEF_multipleTimingAdvance_2 = {
	...
	{ 0, &asn_PER_type_multipleTimingAdvance_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_simultaneousRx_Tx_4 = {
	...
	{ 0, &asn_PER_type_simultaneousRx_Tx_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_additionalRx_Tx_PerformanceReq_7 = {
	...
	{ 0, &asn_PER_type_additionalRx_Tx_PerformanceReq_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_ue_CA_PowerClass_N_9 = {
	...
	{ 0, &asn_PER_type_ue_CA_PowerClass_N_constr_9, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_CA_ParametersEUTRA_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct CA_ParametersEUTRA, supportedNAICS_2CRS_AP),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_supportedNAICS_2CRS_AP_constr_6,  memb_supportedNAICS_2CRS_AP_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct CA_ParametersEUTRA, supportedBandwidthCombinationSetEUTRA_v1530),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_supportedBandwidthCombinationSetEUTRA_v1530_constr_11,  memb_supportedBandwidthCombinationSetEUTRA_v1530_constraint_1 },
		0, 0, /* No default value */
