...
asn_TYPE_descriptor_t asn_DEF_resourceList_3 = {
	...
	{ 0, &asn_PER_type_resourceList_constr_3, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_PUCCH_ResourceSet_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_ResourceSet, resourceList),
		...
		0,
		{ 0, &asn_PER_memb_resourceList_constr_3,  memb_resourceList_constraint_1 },
		0, 0, /* No default value */
		"resourceList"
		},
	{ ATF_POINTER, 1, offsetof(struct PUCCH_ResourceSet, maxPayloadMinus1),
		...
		0,
		{ 0, &asn_PER_memb_maxPayloadMinus1_constr_5,  memb_maxPayloadMinus1_constraint_1 },
		0, 0, /* No default value */
		"maxPayloadMinus1"
		},
};
