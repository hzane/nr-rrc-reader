...
static asn_TYPE_member_t asn_MBR_other_5[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CrossCarrierSchedulingConfig__schedulingCellInfo__other, cif_InSchedulingCell),
		...
		0,
		{ 0, &asn_PER_memb_cif_InSchedulingCell_constr_7,  memb_cif_InSchedulingCell_constraint_5 },
		0, 0, /* No default value */
...
static asn_TYPE_member_t asn_MBR_schedulingCellInfo_2[] = {
	{ ATF_POINTER, 0, offsetof(struct CrossCarrierSchedulingConfig__schedulingCellInfo, own),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_own_3,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct CrossCarrierSchedulingConfig__schedulingCellInfo, other),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_other_5,
		0,
...
asn_TYPE_descriptor_t asn_DEF_schedulingCellInfo_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_schedulingCellInfo_constr_2, CHOICE_constraint },
