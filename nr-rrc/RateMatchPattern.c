...
static asn_TYPE_member_t asn_MBR_symbolsInResourceBlock_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPattern__patternType__bitmaps__symbolsInResourceBlock, oneSlot),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_oneSlot_constr_7,  memb_oneSlot_constraint_6 },
		0, 0, /* No default value */
		"oneSlot"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPattern__patternType__bitmaps__symbolsInResourceBlock, twoSlots),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_twoSlots_constr_8,  memb_twoSlots_constraint_6 },
		0, 0, /* No default value */
		"twoSlots"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_symbolsInResourceBlock_6 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_symbolsInResourceBlock_constr_6, CHOICE_constraint },
...
static asn_TYPE_member_t asn_MBR_periodicityAndPattern_9[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPattern__patternType__bitmaps__periodicityAndPattern, n2),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_n2_constr_10,  memb_n2_constraint_9 },
		0, 0, /* No default value */
		"n2"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPattern__patternType__bitmaps__periodicityAndPattern, n4),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_n4_constr_11,  memb_n4_constraint_9 },
		0, 0, /* No default value */
		"n4"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPattern__patternType__bitmaps__periodicityAndPattern, n5),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_n5_constr_12,  memb_n5_constraint_9 },
		0, 0, /* No default value */
		"n5"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPattern__patternType__bitmaps__periodicityAndPattern, n8),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_n8_constr_13,  memb_n8_constraint_9 },
		0, 0, /* No default value */
		"n8"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPattern__patternType__bitmaps__periodicityAndPattern, n10),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_n10_constr_14,  memb_n10_constraint_9 },
		0, 0, /* No default value */
		"n10"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPattern__patternType__bitmaps__periodicityAndPattern, n20),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_n20_constr_15,  memb_n20_constraint_9 },
		0, 0, /* No default value */
		"n20"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPattern__patternType__bitmaps__periodicityAndPattern, n40),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_n40_constr_16,  memb_n40_constraint_9 },
		0, 0, /* No default value */
		"n40"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_periodicityAndPattern_9 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_periodicityAndPattern_constr_9, CHOICE_constraint },
...
static asn_TYPE_member_t asn_MBR_bitmaps_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPattern__patternType__bitmaps, resourceBlocks),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_resourceBlocks_constr_5,  memb_resourceBlocks_constraint_4 },
		0, 0, /* No default value */
		"resourceBlocks"
		},
...
static asn_TYPE_member_t asn_MBR_patternType_3[] = {
	{ ATF_POINTER, 0, offsetof(struct RateMatchPattern__patternType, bitmaps),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_bitmaps_4,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPattern__patternType, controlResourceSet),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
asn_TYPE_descriptor_t asn_DEF_patternType_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_patternType_constr_3, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_dummy_20 = {
	...
	{ 0, &asn_PER_type_dummy_constr_20, NativeEnumerated_constraint },
