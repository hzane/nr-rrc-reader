...
static asn_TYPE_member_t asn_MBR_ext1_8[] = {
	{ ATF_POINTER, 2, offsetof(struct MeasTiming__ext1, ssb_ToMeasure_v1540),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct MeasTiming__ext1, physCellId),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PhysCellId,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_8 = {
	sizeof(struct MeasTiming__ext1),
	offsetof(struct MeasTiming__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_MeasTiming_1[] = {
	{ ATF_POINTER, 2, offsetof(struct MeasTiming, frequencyAndTiming),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct MeasTiming, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_8,
		0,
...
static const int asn_MAP_MeasTiming_oms_1[] = { 0, 1 };
