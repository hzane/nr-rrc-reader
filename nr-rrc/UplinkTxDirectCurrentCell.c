...
asn_TYPE_descriptor_t asn_DEF_uplinkDirectCurrentBWP_3 = {
	...
	{ 0, &asn_PER_type_uplinkDirectCurrentBWP_constr_3, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_uplinkDirectCurrentBWP_SUL_7 = {
	...
	{ 0, &asn_PER_type_uplinkDirectCurrentBWP_SUL_constr_7, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_ext1_6[] = {
	{ ATF_POINTER, 1, offsetof(struct UplinkTxDirectCurrentCell__ext1, uplinkDirectCurrentBWP_SUL),
		...
		0,
		{ 0, &asn_PER_memb_uplinkDirectCurrentBWP_SUL_constr_7,  memb_uplinkDirectCurrentBWP_SUL_constraint_6 },
		0, 0, /* No default value */
		"uplinkDirectCurrentBWP-SUL"
		},
};
...
asn_TYPE_member_t asn_MBR_UplinkTxDirectCurrentCell_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UplinkTxDirectCurrentCell, uplinkDirectCurrentBWP),
		...
		0,
		{ 0, &asn_PER_memb_uplinkDirectCurrentBWP_constr_3,  memb_uplinkDirectCurrentBWP_constraint_1 },
		0, 0, /* No default value */
		"uplinkDirectCurrentBWP"
		},
