...
static int
memb_uplinkDirectCurrentBWP_SUL_constraint_6(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_type_uplinkDirectCurrentBWP_SUL_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
static asn_per_constraints_t asn_PER_type_uplinkDirectCurrentBWP_SUL_constr_7 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_uplinkDirectCurrentBWP_SUL_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
static asn_per_constraints_t asn_PER_memb_uplinkDirectCurrentBWP_SUL_constr_7 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_uplinkDirectCurrentBWP_SUL_7[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_UplinkTxDirectCurrentBWP,
...
static const ber_tlv_tag_t asn_DEF_uplinkDirectCurrentBWP_SUL_tags_7[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_uplinkDirectCurrentBWP_SUL_specs_7 = {
	sizeof(struct UplinkTxDirectCurrentCell__ext1__uplinkDirectCurrentBWP_SUL),
	offsetof(struct UplinkTxDirectCurrentCell__ext1__uplinkDirectCurrentBWP_SUL, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_uplinkDirectCurrentBWP_SUL_7 = {
	"uplinkDirectCurrentBWP-SUL",
	"uplinkDirectCurrentBWP-SUL",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_uplinkDirectCurrentBWP_SUL_tags_7,
	sizeof(asn_DEF_uplinkDirectCurrentBWP_SUL_tags_7)
		/sizeof(asn_DEF_uplinkDirectCurrentBWP_SUL_tags_7[0]) - 1, /* 1 */
	asn_DEF_uplinkDirectCurrentBWP_SUL_tags_7,	/* Same as above */
	sizeof(asn_DEF_uplinkDirectCurrentBWP_SUL_tags_7)
		/sizeof(asn_DEF_uplinkDirectCurrentBWP_SUL_tags_7[0]), /* 2 */
	{ &asn_OER_type_uplinkDirectCurrentBWP_SUL_constr_7, &asn_PER_type_uplinkDirectCurrentBWP_SUL_constr_7, SEQUENCE_OF_constraint },
	asn_MBR_uplinkDirectCurrentBWP_SUL_7,
	1,	/* Single element */
	&asn_SPC_uplinkDirectCurrentBWP_SUL_specs_7	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_6[] = {
	{ ATF_POINTER, 1, offsetof(struct UplinkTxDirectCurrentCell__ext1, uplinkDirectCurrentBWP_SUL),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_uplinkDirectCurrentBWP_SUL_7,
		0,
		{ &asn_OER_memb_uplinkDirectCurrentBWP_SUL_constr_7, &asn_PER_memb_uplinkDirectCurrentBWP_SUL_constr_7,  memb_uplinkDirectCurrentBWP_SUL_constraint_6 },
		0, 0, /* No default value */
		"uplinkDirectCurrentBWP-SUL"
		},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_6 = {
	sizeof(struct UplinkTxDirectCurrentCell__ext1),
	offsetof(struct UplinkTxDirectCurrentCell__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_UplinkTxDirectCurrentCell_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct UplinkTxDirectCurrentCell, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_6,
		0,
