...
asn_TYPE_descriptor_t asn_DEF_guami_Type_4 = {
	...
	{ 0, &asn_PER_type_guami_Type_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_s_NSSAI_List_7 = {
	...
	{ 0, &asn_PER_type_s_NSSAI_List_constr_7, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_ng_5G_S_TMSI_Value_10[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCSetupComplete_IEs__ng_5G_S_TMSI_Value, ng_5G_S_TMSI),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCSetupComplete_IEs__ng_5G_S_TMSI_Value, ng_5G_S_TMSI_Part2),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ng_5G_S_TMSI_Part2_constr_12,  memb_ng_5G_S_TMSI_Part2_constraint_10 },
		0, 0, /* No default value */
		"ng-5G-S-TMSI-Part2"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_ng_5G_S_TMSI_Value_10 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_ng_5G_S_TMSI_Value_constr_10, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_RRCSetupComplete_IEs_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RRCSetupComplete_IEs, s_NSSAI_List),
		...
		0,
		{ 0, &asn_PER_memb_s_NSSAI_List_constr_7,  memb_s_NSSAI_List_constraint_1 },
		0, 0, /* No default value */
		"s-NSSAI-List"
		},
