...
asn_TYPE_descriptor_t asn_DEF_si_RequestPeriod_13 = {
	...
	{ 0, &asn_PER_type_si_RequestPeriod_constr_13, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_si_RequestResources_22 = {
	...
	{ 0, &asn_PER_type_si_RequestResources_constr_22, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_SI_RequestConfig_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SI_RequestConfig, si_RequestResources),
		...
		0,
		{ 0, &asn_PER_memb_si_RequestResources_constr_22,  memb_si_RequestResources_constraint_1 },
		0, 0, /* No default value */
		"si-RequestResources"
		},
};
