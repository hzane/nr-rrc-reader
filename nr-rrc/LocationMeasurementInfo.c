...
asn_TYPE_member_t asn_MBR_LocationMeasurementInfo_1[] = {
	{ ATF_POINTER, 0, offsetof(struct LocationMeasurementInfo, eutra_RSTD),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LocationMeasurementInfo, eutra_FineTimingDetection),
...
asn_TYPE_descriptor_t asn_DEF_LocationMeasurementInfo = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_LocationMeasurementInfo_constr_1, CHOICE_constraint },
