...
static asn_oer_constraints_t asn_OER_type_independentGapConfig_constr_18 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_independentGapConfig_constr_18 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_periodicEUTRA_MeasAndReport_constr_20 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_periodicEUTRA_MeasAndReport_constr_20 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_handoverFR1_FR2_constr_22 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_handoverFR1_FR2_constr_22 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_maxNumberCSI_RS_RRM_RS_SINR_constr_24 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_maxNumberCSI_RS_RRM_RS_SINR_constr_24 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  5 }	/* (0..5) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_nr_CGI_Reporting_ENDC_constr_32 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_nr_CGI_Reporting_ENDC_constr_32 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_independentGapConfig_value2enum_18[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_independentGapConfig_enum2value_18[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_independentGapConfig_specs_18 = {
	asn_MAP_independentGapConfig_value2enum_18,	/* "tag" => N; sorted by tag */
	asn_MAP_independentGapConfig_enum2value_18,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_independentGapConfig_tags_18[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_independentGapConfig_18 = {
	"independentGapConfig",
	"independentGapConfig",
	&asn_OP_NativeEnumerated,
	asn_DEF_independentGapConfig_tags_18,
	sizeof(asn_DEF_independentGapConfig_tags_18)
		/sizeof(asn_DEF_independentGapConfig_tags_18[0]) - 1, /* 1 */
	asn_DEF_independentGapConfig_tags_18,	/* Same as above */
	sizeof(asn_DEF_independentGapConfig_tags_18)
		/sizeof(asn_DEF_independentGapConfig_tags_18[0]), /* 2 */
	{ &asn_OER_type_independentGapConfig_constr_18, &asn_PER_type_independentGapConfig_constr_18, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_independentGapConfig_specs_18	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_periodicEUTRA_MeasAndReport_value2enum_20[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_periodicEUTRA_MeasAndReport_enum2value_20[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_periodicEUTRA_MeasAndReport_specs_20 = {
	asn_MAP_periodicEUTRA_MeasAndReport_value2enum_20,	/* "tag" => N; sorted by tag */
	asn_MAP_periodicEUTRA_MeasAndReport_enum2value_20,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_periodicEUTRA_MeasAndReport_tags_20[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_periodicEUTRA_MeasAndReport_20 = {
	"periodicEUTRA-MeasAndReport",
	"periodicEUTRA-MeasAndReport",
	&asn_OP_NativeEnumerated,
	asn_DEF_periodicEUTRA_MeasAndReport_tags_20,
	sizeof(asn_DEF_periodicEUTRA_MeasAndReport_tags_20)
		/sizeof(asn_DEF_periodicEUTRA_MeasAndReport_tags_20[0]) - 1, /* 1 */
	asn_DEF_periodicEUTRA_MeasAndReport_tags_20,	/* Same as above */
	sizeof(asn_DEF_periodicEUTRA_MeasAndReport_tags_20)
		/sizeof(asn_DEF_periodicEUTRA_MeasAndReport_tags_20[0]), /* 2 */
	{ &asn_OER_type_periodicEUTRA_MeasAndReport_constr_20, &asn_PER_type_periodicEUTRA_MeasAndReport_constr_20, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_periodicEUTRA_MeasAndReport_specs_20	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_handoverFR1_FR2_value2enum_22[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_handoverFR1_FR2_enum2value_22[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_handoverFR1_FR2_specs_22 = {
	asn_MAP_handoverFR1_FR2_value2enum_22,	/* "tag" => N; sorted by tag */
	asn_MAP_handoverFR1_FR2_enum2value_22,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_handoverFR1_FR2_tags_22[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_handoverFR1_FR2_22 = {
	"handoverFR1-FR2",
	"handoverFR1-FR2",
	&asn_OP_NativeEnumerated,
	asn_DEF_handoverFR1_FR2_tags_22,
	sizeof(asn_DEF_handoverFR1_FR2_tags_22)
		/sizeof(asn_DEF_handoverFR1_FR2_tags_22[0]) - 1, /* 1 */
	asn_DEF_handoverFR1_FR2_tags_22,	/* Same as above */
	sizeof(asn_DEF_handoverFR1_FR2_tags_22)
		/sizeof(asn_DEF_handoverFR1_FR2_tags_22[0]), /* 2 */
	{ &asn_OER_type_handoverFR1_FR2_constr_22, &asn_PER_type_handoverFR1_FR2_constr_22, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_handoverFR1_FR2_specs_22	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_maxNumberCSI_RS_RRM_RS_SINR_value2enum_24[] = {
	{ 0,	2,	"n4" },
	{ 1,	2,	"n8" },
	{ 2,	3,	"n16" },
	{ 3,	3,	"n32" },
...
static const unsigned int asn_MAP_maxNumberCSI_RS_RRM_RS_SINR_enum2value_24[] = {
	2,	/* n16(2) */
	3,	/* n32(3) */
	0,	/* n4(0) */
	4,	/* n64(4) */
...
static const asn_INTEGER_specifics_t asn_SPC_maxNumberCSI_RS_RRM_RS_SINR_specs_24 = {
	asn_MAP_maxNumberCSI_RS_RRM_RS_SINR_value2enum_24,	/* "tag" => N; sorted by tag */
	asn_MAP_maxNumberCSI_RS_RRM_RS_SINR_enum2value_24,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_maxNumberCSI_RS_RRM_RS_SINR_tags_24[] = {
	(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_maxNumberCSI_RS_RRM_RS_SINR_24 = {
	"maxNumberCSI-RS-RRM-RS-SINR",
	"maxNumberCSI-RS-RRM-RS-SINR",
	&asn_OP_NativeEnumerated,
	asn_DEF_maxNumberCSI_RS_RRM_RS_SINR_tags_24,
	sizeof(asn_DEF_maxNumberCSI_RS_RRM_RS_SINR_tags_24)
		/sizeof(asn_DEF_maxNumberCSI_RS_RRM_RS_SINR_tags_24[0]) - 1, /* 1 */
	asn_DEF_maxNumberCSI_RS_RRM_RS_SINR_tags_24,	/* Same as above */
	sizeof(asn_DEF_maxNumberCSI_RS_RRM_RS_SINR_tags_24)
		/sizeof(asn_DEF_maxNumberCSI_RS_RRM_RS_SINR_tags_24[0]), /* 2 */
	{ &asn_OER_type_maxNumberCSI_RS_RRM_RS_SINR_constr_24, &asn_PER_type_maxNumberCSI_RS_RRM_RS_SINR_constr_24, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_maxNumberCSI_RS_RRM_RS_SINR_specs_24	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_17[] = {
	{ ATF_POINTER, 4, offsetof(struct MeasAndMobParametersCommon__ext2, independentGapConfig),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_independentGapConfig_18,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"independentGapConfig"
		},
	{ ATF_POINTER, 3, offsetof(struct MeasAndMobParametersCommon__ext2, periodicEUTRA_MeasAndReport),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_periodicEUTRA_MeasAndReport_20,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"periodicEUTRA-MeasAndReport"
		},
	{ ATF_POINTER, 2, offsetof(struct MeasAndMobParametersCommon__ext2, handoverFR1_FR2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_handoverFR1_FR2_22,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"handoverFR1-FR2"
		},
	{ ATF_POINTER, 1, offsetof(struct MeasAndMobParametersCommon__ext2, maxNumberCSI_RS_RRM_RS_SINR),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_maxNumberCSI_RS_RRM_RS_SINR_24,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"maxNumberCSI-RS-RRM-RS-SINR"
...
static const int asn_MAP_ext2_oms_17[] = { 0, 1, 2, 3 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_17 = {
	sizeof(struct MeasAndMobParametersCommon__ext2),
	offsetof(struct MeasAndMobParametersCommon__ext2, _asn_ctx),
...
static const asn_INTEGER_enum_map_t asn_MAP_nr_CGI_Reporting_ENDC_value2enum_32[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_nr_CGI_Reporting_ENDC_enum2value_32[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_nr_CGI_Reporting_ENDC_specs_32 = {
	asn_MAP_nr_CGI_Reporting_ENDC_value2enum_32,	/* "tag" => N; sorted by tag */
	asn_MAP_nr_CGI_Reporting_ENDC_enum2value_32,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_nr_CGI_Reporting_ENDC_tags_32[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_nr_CGI_Reporting_ENDC_32 = {
	"nr-CGI-Reporting-ENDC",
	"nr-CGI-Reporting-ENDC",
	&asn_OP_NativeEnumerated,
	asn_DEF_nr_CGI_Reporting_ENDC_tags_32,
	sizeof(asn_DEF_nr_CGI_Reporting_ENDC_tags_32)
		/sizeof(asn_DEF_nr_CGI_Reporting_ENDC_tags_32[0]) - 1, /* 1 */
	asn_DEF_nr_CGI_Reporting_ENDC_tags_32,	/* Same as above */
	sizeof(asn_DEF_nr_CGI_Reporting_ENDC_tags_32)
		/sizeof(asn_DEF_nr_CGI_Reporting_ENDC_tags_32[0]), /* 2 */
	{ &asn_OER_type_nr_CGI_Reporting_ENDC_constr_32, &asn_PER_type_nr_CGI_Reporting_ENDC_constr_32, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_nr_CGI_Reporting_ENDC_specs_32	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext3_31[] = {
	{ ATF_POINTER, 1, offsetof(struct MeasAndMobParametersCommon__ext3, nr_CGI_Reporting_ENDC),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_nr_CGI_Reporting_ENDC_32,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"nr-CGI-Reporting-ENDC"
...
static const int asn_MAP_ext3_oms_31[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext3_tags_31[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext3_tag2el_31[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* nr-CGI-Reporting-ENDC */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_31 = {
	sizeof(struct MeasAndMobParametersCommon__ext3),
	offsetof(struct MeasAndMobParametersCommon__ext3, _asn_ctx),
	asn_MAP_ext3_tag2el_31,
	1,	/* Count of tags in the map */
	asn_MAP_ext3_oms_31,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext3_31 = {
	"ext3",
	"ext3",
	&asn_OP_SEQUENCE,
	asn_DEF_ext3_tags_31,
	sizeof(asn_DEF_ext3_tags_31)
		/sizeof(asn_DEF_ext3_tags_31[0]) - 1, /* 1 */
	asn_DEF_ext3_tags_31,	/* Same as above */
	sizeof(asn_DEF_ext3_tags_31)
		/sizeof(asn_DEF_ext3_tags_31[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_ext3_31,
	1,	/* Elements count */
	&asn_SPC_ext3_specs_31	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_MeasAndMobParametersCommon_1[] = {
	{ ATF_POINTER, 6, offsetof(struct MeasAndMobParametersCommon, supportedGapPattern),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct MeasAndMobParametersCommon, ssb_RLM),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ssb_RLM_3,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct MeasAndMobParametersCommon, ssb_AndCSI_RS_RLM),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct MeasAndMobParametersCommon, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_8,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct MeasAndMobParametersCommon, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext2_17,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct MeasAndMobParametersCommon, ext3),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext3_31,
		0,
...
static const int asn_MAP_MeasAndMobParametersCommon_oms_1[] = { 0, 1, 2, 3, 4, 5 };
