...
asn_TYPE_descriptor_t asn_DEF_pci_List_2 = {
	...
	{ 0, &asn_PER_type_pci_List_constr_2, SEQUENCE_OF_constraint },
	asn_MBR_pci_List_2,
	1,	/* Single element */
...
asn_TYPE_descriptor_t asn_DEF_periodicity_4 = {
	...
	{ 0, &asn_PER_type_periodicity_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SSB_MTC2_1[] = {
	{ ATF_POINTER, 1, offsetof(struct SSB_MTC2, pci_List),
		...
		&asn_DEF_pci_List_2,
		0,
		{ 0, &asn_PER_memb_pci_List_constr_2,  memb_pci_List_constraint_1 },
		0, 0, /* No default value */
		"pci-List"
		},
