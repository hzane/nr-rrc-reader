...
asn_TYPE_descriptor_t asn_DEF_lcp_Restriction_2 = {
	...
	{ 0, &asn_PER_type_lcp_Restriction_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_dummy_4 = {
	...
	{ 0, &asn_PER_type_dummy_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_lch_ToSCellRestriction_6 = {
	...
	{ 0, &asn_PER_type_lch_ToSCellRestriction_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_recommendedBitRate_10 = {
	...
	{ 0, &asn_PER_type_recommendedBitRate_constr_10, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_recommendedBitRateQuery_12 = {
	...
	{ 0, &asn_PER_type_recommendedBitRateQuery_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_MAC_ParametersCommon_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct MAC_ParametersCommon, dummy),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_dummy_4,
		0,
