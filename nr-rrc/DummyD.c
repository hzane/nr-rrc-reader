...
asn_TYPE_descriptor_t asn_DEF_maxNumberTxPortsPerResource_2 = {
	...
	{ 0, &asn_PER_type_maxNumberTxPortsPerResource_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_amplitudeScalingType_12 = {
	...
	{ 0, &asn_PER_type_amplitudeScalingType_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_amplitudeSubsetRestriction_15 = {
	...
	{ 0, &asn_PER_type_amplitudeSubsetRestriction_constr_15, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_DummyD_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyD, maxNumberResources),
		...
		0,
		{ 0, &asn_PER_memb_maxNumberResources_constr_9,  memb_maxNumberResources_constraint_1 },
		0, 0, /* No default value */
		"maxNumberResources"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct DummyD, totalNumberTxPorts),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_totalNumberTxPorts_constr_10,  memb_totalNumberTxPorts_constraint_1 },
		0, 0, /* No default value */
		"totalNumberTxPorts"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct DummyD, parameterLx),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_parameterLx_constr_11,  memb_parameterLx_constraint_1 },
		0, 0, /* No default value */
		"parameterLx"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyD, maxNumberCSI_RS_PerResourceSet),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberCSI_RS_PerResourceSet_constr_17,  memb_maxNumberCSI_RS_PerResourceSet_constraint_1 },
		0, 0, /* No default value */
