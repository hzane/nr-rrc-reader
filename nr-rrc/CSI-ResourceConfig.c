...
asn_TYPE_descriptor_t asn_DEF_nzp_CSI_RS_ResourceSetList_5 = {
	...
	{ 0, &asn_PER_type_nzp_CSI_RS_ResourceSetList_constr_5, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_csi_SSB_ResourceSetList_7 = {
	...
	{ 0, &asn_PER_type_csi_SSB_ResourceSetList_constr_7, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_nzp_CSI_RS_SSB_4[] = {
	{ ATF_POINTER, 2, offsetof(struct CSI_ResourceConfig__csi_RS_ResourceSetList__nzp_CSI_RS_SSB, nzp_CSI_RS_ResourceSetList),
		...
		0,
		{ 0, &asn_PER_memb_nzp_CSI_RS_ResourceSetList_constr_5,  memb_nzp_CSI_RS_ResourceSetList_constraint_4 },
		0, 0, /* No default value */
		"nzp-CSI-RS-ResourceSetList"
		},
	{ ATF_POINTER, 1, offsetof(struct CSI_ResourceConfig__csi_RS_ResourceSetList__nzp_CSI_RS_SSB, csi_SSB_ResourceSetList),
		...
		0,
		{ 0, &asn_PER_memb_csi_SSB_ResourceSetList_constr_7,  memb_csi_SSB_ResourceSetList_constraint_4 },
		0, 0, /* No default value */
		"csi-SSB-ResourceSetList"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_csi_IM_ResourceSetList_9 = {
	...
	{ 0, &asn_PER_type_csi_IM_ResourceSetList_constr_9, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_csi_RS_ResourceSetList_3[] = {
	{ ATF_POINTER, 0, offsetof(struct CSI_ResourceConfig__csi_RS_ResourceSetList, nzp_CSI_RS_SSB),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct CSI_ResourceConfig__csi_RS_ResourceSetList, csi_IM_ResourceSetList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_csi_IM_ResourceSetList_9,
		0,
		{ 0, &asn_PER_memb_csi_IM_ResourceSetList_constr_9,  memb_csi_IM_ResourceSetList_constraint_3 },
		0, 0, /* No default value */
		"csi-IM-ResourceSetList"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_csi_RS_ResourceSetList_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_csi_RS_ResourceSetList_constr_3, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_resourceType_12 = {
	...
	{ 0, &asn_PER_type_resourceType_constr_12, NativeEnumerated_constraint },
