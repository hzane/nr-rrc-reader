...
static asn_per_constraints_t asn_PER_type_refServCellIndicator_constr_21 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_mgl_3 = {
	...
	{ 0, &asn_PER_type_mgl_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_mgrp_10 = {
	...
	{ 0, &asn_PER_type_mgrp_constr_10, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_mgta_15 = {
	...
	{ 0, &asn_PER_type_mgta_constr_15, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_mgta_specs_15	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_refServCellIndicator_value2enum_21[] = {
	{ 0,	5,	"pCell" },
	{ 1,	6,	"pSCell" },
	{ 2,	7,	"mcg-FR2" }
};
static const unsigned int asn_MAP_refServCellIndicator_enum2value_21[] = {
	2,	/* mcg-FR2(2) */
	0,	/* pCell(0) */
	1	/* pSCell(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_refServCellIndicator_specs_21 = {
	asn_MAP_refServCellIndicator_value2enum_21,	/* "tag" => N; sorted by tag */
	asn_MAP_refServCellIndicator_enum2value_21,	/* N => "tag"; sorted by N */
	3,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_refServCellIndicator_tags_21[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_refServCellIndicator_21 = {
	"refServCellIndicator",
	"refServCellIndicator",
	&asn_OP_NativeEnumerated,
	asn_DEF_refServCellIndicator_tags_21,
	sizeof(asn_DEF_refServCellIndicator_tags_21)
		/sizeof(asn_DEF_refServCellIndicator_tags_21[0]) - 1, /* 1 */
	asn_DEF_refServCellIndicator_tags_21,	/* Same as above */
	sizeof(asn_DEF_refServCellIndicator_tags_21)
		/sizeof(asn_DEF_refServCellIndicator_tags_21[0]), /* 2 */
	{ 0, &asn_PER_type_refServCellIndicator_constr_21, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_refServCellIndicator_specs_21	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_20[] = {
	{ ATF_POINTER, 1, offsetof(struct GapConfig__ext1, refServCellIndicator),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_refServCellIndicator_21,
		0,
		{ 0, 0, 0 },
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_20 = {
	sizeof(struct GapConfig__ext1),
	offsetof(struct GapConfig__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_GapConfig_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GapConfig, gapOffset),
		...
		0,
		{ 0, &asn_PER_memb_gapOffset_constr_2,  memb_gapOffset_constraint_1 },
		0, 0, /* No default value */
		"gapOffset"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct GapConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_20,
		0,
