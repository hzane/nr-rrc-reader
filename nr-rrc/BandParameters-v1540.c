...
asn_TYPE_descriptor_t asn_DEF_srs_SwitchingTimesListNR_4 = {
	...
	{ 0, &asn_PER_type_srs_SwitchingTimesListNR_constr_4, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_nr_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct BandParameters_v1540__srs_CarrierSwitch__nr, srs_SwitchingTimesListNR),
		...
		0,
		{ 0, &asn_PER_memb_srs_SwitchingTimesListNR_constr_4,  memb_srs_SwitchingTimesListNR_constraint_3 },
		0, 0, /* No default value */
		"srs-SwitchingTimesListNR"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_srs_SwitchingTimesListEUTRA_7 = {
	...
	{ 0, &asn_PER_type_srs_SwitchingTimesListEUTRA_constr_7, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_eutra_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct BandParameters_v1540__srs_CarrierSwitch__eutra, srs_SwitchingTimesListEUTRA),
		...
		0,
		{ 0, &asn_PER_memb_srs_SwitchingTimesListEUTRA_constr_7,  memb_srs_SwitchingTimesListEUTRA_constraint_6 },
		0, 0, /* No default value */
		"srs-SwitchingTimesListEUTRA"
		},
};
...
static asn_TYPE_member_t asn_MBR_srs_CarrierSwitch_2[] = {
	{ ATF_POINTER, 0, offsetof(struct BandParameters_v1540__srs_CarrierSwitch, nr),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_nr_3,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct BandParameters_v1540__srs_CarrierSwitch, eutra),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_eutra_6,
		0,
...
asn_TYPE_descriptor_t asn_DEF_srs_CarrierSwitch_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_srs_CarrierSwitch_constr_2, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_supportedSRS_TxPortSwitch_10 = {
	...
	{ 0, &asn_PER_type_supportedSRS_TxPortSwitch_constr_10, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_srs_TxSwitch_9[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct BandParameters_v1540__srs_TxSwitch, txSwitchImpactToRx),
		...
		0,
		{ 0, &asn_PER_memb_txSwitchImpactToRx_constr_19,  memb_txSwitchImpactToRx_constraint_9 },
		0, 0, /* No default value */
		"txSwitchImpactToRx"
		},
	{ ATF_POINTER, 1, offsetof(struct BandParameters_v1540__srs_TxSwitch, txSwitchWithAnotherBand),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_txSwitchWithAnotherBand_constr_20,  memb_txSwitchWithAnotherBand_constraint_9 },
		0, 0, /* No default value */
