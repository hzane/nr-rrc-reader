...
asn_TYPE_member_t asn_MBR_SSB_ToMeasure_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SSB_ToMeasure, shortBitmap),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_shortBitmap_constr_2,  memb_shortBitmap_constraint_1 },
		0, 0, /* No default value */
		"shortBitmap"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SSB_ToMeasure, mediumBitmap),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_mediumBitmap_constr_3,  memb_mediumBitmap_constraint_1 },
		0, 0, /* No default value */
		"mediumBitmap"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SSB_ToMeasure, longBitmap),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_longBitmap_constr_4,  memb_longBitmap_constraint_1 },
		0, 0, /* No default value */
		"longBitmap"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_SSB_ToMeasure = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_SSB_ToMeasure_constr_1, CHOICE_constraint },
