...
asn_TYPE_descriptor_t asn_DEF_n_TimingAdvanceOffset_6 = {
	...
	{ 0, &asn_PER_type_n_TimingAdvanceOffset_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_n_TimingAdvanceOffset_specs_6	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ssb_PositionsInBurst_10[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ServingCellConfigCommon__ssb_PositionsInBurst, shortBitmap),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_shortBitmap_constr_11,  memb_shortBitmap_constraint_10 },
		0, 0, /* No default value */
		"shortBitmap"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct ServingCellConfigCommon__ssb_PositionsInBurst, mediumBitmap),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_mediumBitmap_constr_12,  memb_mediumBitmap_constraint_10 },
		0, 0, /* No default value */
		"mediumBitmap"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct ServingCellConfigCommon__ssb_PositionsInBurst, longBitmap),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_longBitmap_constr_13,  memb_longBitmap_constraint_10 },
		0, 0, /* No default value */
		"longBitmap"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_ssb_PositionsInBurst_10 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_ssb_PositionsInBurst_constr_10, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_ssb_periodicityServingCell_14 = {
	...
	{ 0, &asn_PER_type_ssb_periodicityServingCell_constr_14, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_dmrs_TypeA_Position_23 = {
	...
	{ 0, &asn_PER_type_dmrs_TypeA_Position_constr_23, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_rateMatchPatternToAddModList_27 = {
	...
	{ 0, &asn_PER_type_rateMatchPatternToAddModList_constr_27, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_rateMatchPatternToReleaseList_29 = {
	...
	{ 0, &asn_PER_type_rateMatchPatternToReleaseList_constr_29, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_ServingCellConfigCommon_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct ServingCellConfigCommon, rateMatchPatternToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_rateMatchPatternToAddModList_constr_27,  memb_rateMatchPatternToAddModList_constraint_1 },
		0, 0, /* No default value */
		"rateMatchPatternToAddModList"
		},
	{ ATF_POINTER, 3, offsetof(struct ServingCellConfigCommon, rateMatchPatternToReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_rateMatchPatternToReleaseList_constr_29,  memb_rateMatchPatternToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"rateMatchPatternToReleaseList"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ServingCellConfigCommon, ss_PBCH_BlockPower),
		...
		0,
		{ 0, &asn_PER_memb_ss_PBCH_BlockPower_constr_33,  memb_ss_PBCH_BlockPower_constraint_1 },
		0, 0, /* No default value */
		"ss-PBCH-BlockPower"
		},
};
