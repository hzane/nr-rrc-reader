...
asn_TYPE_descriptor_t asn_DEF_q_Hyst_6 = {
	...
	{ 0, &asn_PER_type_q_Hyst_constr_6, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_sf_Medium_26 = {
	...
	{ 0, &asn_PER_type_sf_Medium_constr_26, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_sf_High_31 = {
	...
	{ 0, &asn_PER_type_sf_High_constr_31, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_cellReselectionInfoCommon_2[] = {
	{ ATF_POINTER, 3, offsetof(struct SIB2__cellReselectionInfoCommon, nrofSS_BlocksToAverage),
		...
		0,
		{ 0, &asn_PER_memb_nrofSS_BlocksToAverage_constr_3,  memb_nrofSS_BlocksToAverage_constraint_2 },
		0, 0, /* No default value */
