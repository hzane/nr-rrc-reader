...
asn_TYPE_descriptor_t asn_DEF_maxLength_8 = {
	...
	{ 0, &asn_PER_type_maxLength_constr_8, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_DMRS_DownlinkConfig_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct DMRS_DownlinkConfig, scramblingID0),
		...
		0,
		{ 0, &asn_PER_memb_scramblingID0_constr_10,  memb_scramblingID0_constraint_1 },
		0, 0, /* No default value */
		"scramblingID0"
		},
	{ ATF_POINTER, 2, offsetof(struct DMRS_DownlinkConfig, scramblingID1),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_scramblingID1_constr_11,  memb_scramblingID1_constraint_1 },
		0, 0, /* No default value */
		"scramblingID1"
		},
	{ ATF_POINTER, 1, offsetof(struct DMRS_DownlinkConfig, phaseTrackingRS),
		...
		&asn_DEF_SetupRelease_PTRS_DownlinkConfig,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"phaseTrackingRS"
