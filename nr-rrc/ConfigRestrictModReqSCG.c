...
static asn_oer_constraints_t asn_OER_memb_requestedPDCCH_BlindDetectionSCG_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (1..15) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_ext1_5[] = {
	{ ATF_POINTER, 2, offsetof(struct ConfigRestrictModReqSCG__ext1, requestedPDCCH_BlindDetectionSCG),
		...
		0,
		{ &asn_OER_memb_requestedPDCCH_BlindDetectionSCG_constr_6, &asn_PER_memb_requestedPDCCH_BlindDetectionSCG_constr_6,  memb_requestedPDCCH_BlindDetectionSCG_constraint_5 },
