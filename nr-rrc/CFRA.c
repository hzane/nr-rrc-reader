...
asn_TYPE_descriptor_t asn_DEF_ssb_perRACH_Occasion_4 = {
	...
	{ 0, &asn_PER_type_ssb_perRACH_Occasion_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_ssb_ResourceList_15 = {
	...
	{ 0, &asn_PER_type_ssb_ResourceList_constr_15, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_ssb_14[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CFRA__resources__ssb, ssb_ResourceList),
		...
		0,
		{ 0, &asn_PER_memb_ssb_ResourceList_constr_15,  memb_ssb_ResourceList_constraint_14 },
		0, 0, /* No default value */
		"ssb-ResourceList"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CFRA__resources__ssb, ra_ssb_OccasionMaskIndex),
		...
		0,
		{ 0, &asn_PER_memb_ra_ssb_OccasionMaskIndex_constr_17,  memb_ra_ssb_OccasionMaskIndex_constraint_14 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_csirs_ResourceList_19 = {
	...
	{ 0, &asn_PER_type_csirs_ResourceList_constr_19, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_csirs_18[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CFRA__resources__csirs, csirs_ResourceList),
		...
		0,
		{ 0, &asn_PER_memb_csirs_ResourceList_constr_19,  memb_csirs_ResourceList_constraint_18 },
		0, 0, /* No default value */
		"csirs-ResourceList"
		},
...
static asn_TYPE_member_t asn_MBR_resources_13[] = {
	{ ATF_POINTER, 0, offsetof(struct CFRA__resources, ssb),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_ssb_14,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct CFRA__resources, csirs),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_csirs_18,
		0,
...
asn_TYPE_descriptor_t asn_DEF_resources_13 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_resources_constr_13, CHOICE_constraint },
...
static asn_TYPE_member_t asn_MBR_ext1_23[] = {
	{ ATF_POINTER, 1, offsetof(struct CFRA__ext1, totalNumberOfRA_Preambles_v1530),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_totalNumberOfRA_Preambles_v1530_constr_24,  memb_totalNumberOfRA_Preambles_v1530_constraint_23 },
		0, 0, /* No default value */
