...
asn_TYPE_descriptor_t asn_DEF_maxNumberAperiodicCSI_triggeringStatePerCC_7 = {
	...
	{ 0, &asn_PER_type_maxNumberAperiodicCSI_triggeringStatePerCC_constr_7, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_CSI_ReportFramework_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_ReportFramework, maxNumberPeriodicCSI_PerBWP_ForCSI_Report),
		...
		0,
		{ 0, &asn_PER_memb_maxNumberPeriodicCSI_PerBWP_ForCSI_Report_constr_2,  memb_maxNumberPeriodicCSI_PerBWP_ForCSI_Report_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_ReportFramework, maxNumberAperiodicCSI_PerBWP_ForCSI_Report),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberAperiodicCSI_PerBWP_ForCSI_Report_constr_3,  memb_maxNumberAperiodicCSI_PerBWP_ForCSI_Report_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_ReportFramework, maxNumberSemiPersistentCSI_PerBWP_ForCSI_Report),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberSemiPersistentCSI_PerBWP_ForCSI_Report_constr_4,  memb_maxNumberSemiPersistentCSI_PerBWP_ForCSI_Report_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_ReportFramework, maxNumberPeriodicCSI_PerBWP_ForBeamReport),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberPeriodicCSI_PerBWP_ForBeamReport_constr_5,  memb_maxNumberPeriodicCSI_PerBWP_ForBeamReport_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_ReportFramework, maxNumberAperiodicCSI_PerBWP_ForBeamReport),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberAperiodicCSI_PerBWP_ForBeamReport_constr_6,  memb_maxNumberAperiodicCSI_PerBWP_ForBeamReport_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_ReportFramework, maxNumberSemiPersistentCSI_PerBWP_ForBeamReport),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberSemiPersistentCSI_PerBWP_ForBeamReport_constr_14,  memb_maxNumberSemiPersistentCSI_PerBWP_ForBeamReport_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_ReportFramework, simultaneousCSI_ReportsPerCC),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_simultaneousCSI_ReportsPerCC_constr_15,  memb_simultaneousCSI_ReportsPerCC_constraint_1 },
		0, 0, /* No default value */
