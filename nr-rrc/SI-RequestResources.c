...
asn_TYPE_member_t asn_MBR_SI_RequestResources_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SI_RequestResources, ra_PreambleStartIndex),
		...
		0,
		{ 0, &asn_PER_memb_ra_PreambleStartIndex_constr_2,  memb_ra_PreambleStartIndex_constraint_1 },
	...
	{ ATF_POINTER, 2, offsetof(struct SI_RequestResources, ra_AssociationPeriodIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ra_AssociationPeriodIndex_constr_3,  memb_ra_AssociationPeriodIndex_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct SI_RequestResources, ra_ssb_OccasionMaskIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ra_ssb_OccasionMaskIndex_constr_4,  memb_ra_ssb_OccasionMaskIndex_constraint_1 },
		0, 0, /* No default value */
