...
asn_TYPE_member_t asn_MBR_CellIdentity_EUTRA_5GC_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CellIdentity_EUTRA_5GC, cellIdentity_EUTRA),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_cellIdentity_EUTRA_constr_2,  memb_cellIdentity_EUTRA_constraint_1 },
		0, 0, /* No default value */
		"cellIdentity-EUTRA"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CellIdentity_EUTRA_5GC, cellId_index),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_cellId_index_constr_3,  memb_cellId_index_constraint_1 },
		0, 0, /* No default value */
		"cellId-index"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_CellIdentity_EUTRA_5GC = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_CellIdentity_EUTRA_5GC_constr_1, CHOICE_constraint },
