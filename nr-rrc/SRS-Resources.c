...
asn_TYPE_descriptor_t asn_DEF_maxNumberAperiodicSRS_PerBWP_2 = {
	...
	{ 0, &asn_PER_type_maxNumberAperiodicSRS_PerBWP_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_maxNumberPeriodicSRS_PerBWP_9 = {
	...
	{ 0, &asn_PER_type_maxNumberPeriodicSRS_PerBWP_constr_9, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_maxNumberSemiPersistentSRS_PerBWP_16 = {
	...
	{ 0, &asn_PER_type_maxNumberSemiPersistentSRS_PerBWP_constr_16, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_maxNumberSRS_Ports_PerResource_23 = {
	...
	{ 0, &asn_PER_type_maxNumberSRS_Ports_PerResource_constr_23, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_SRS_Resources_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resources, maxNumberAperiodicSRS_PerBWP_PerSlot),
		...
		0,
		{ 0, &asn_PER_memb_maxNumberAperiodicSRS_PerBWP_PerSlot_constr_8,  memb_maxNumberAperiodicSRS_PerBWP_PerSlot_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resources, maxNumberPeriodicSRS_PerBWP_PerSlot),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberPeriodicSRS_PerBWP_PerSlot_constr_15,  memb_maxNumberPeriodicSRS_PerBWP_PerSlot_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resources, maxNumberSemiPersistentSRS_PerBWP_PerSlot),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberSemiPersistentSRS_PerBWP_PerSlot_constr_22,  memb_maxNumberSemiPersistentSRS_PerBWP_PerSlot_constraint_1 },
		0, 0, /* No default value */
