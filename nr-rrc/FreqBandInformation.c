...
asn_TYPE_member_t asn_MBR_FreqBandInformation_1[] = {
	{ ATF_POINTER, 0, offsetof(struct FreqBandInformation, bandInformationEUTRA),
	...
	{ ATF_POINTER, 0, offsetof(struct FreqBandInformation, bandInformationNR),
...
asn_TYPE_descriptor_t asn_DEF_FreqBandInformation = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_FreqBandInformation_constr_1, CHOICE_constraint },
