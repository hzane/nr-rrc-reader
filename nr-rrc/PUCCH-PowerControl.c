...
asn_TYPE_descriptor_t asn_DEF_p0_Set_7 = {
	...
	{ 0, &asn_PER_type_p0_Set_constr_7, SEQUENCE_OF_constraint },
	asn_MBR_p0_Set_7,
	1,	/* Single element */
...
asn_TYPE_descriptor_t asn_DEF_pathlossReferenceRSs_9 = {
	...
	{ 0, &asn_PER_type_pathlossReferenceRSs_constr_9, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_twoPUCCH_PC_AdjustmentStates_11 = {
	...
	{ 0, &asn_PER_type_twoPUCCH_PC_AdjustmentStates_constr_11, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_PUCCH_PowerControl_1[] = {
	{ ATF_POINTER, 8, offsetof(struct PUCCH_PowerControl, deltaF_PUCCH_f0),
		...
		0,
		{ 0, &asn_PER_memb_deltaF_PUCCH_f0_constr_2,  memb_deltaF_PUCCH_f0_constraint_1 },
		0, 0, /* No default value */
		"deltaF-PUCCH-f0"
		},
	{ ATF_POINTER, 7, offsetof(struct PUCCH_PowerControl, deltaF_PUCCH_f1),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_deltaF_PUCCH_f1_constr_3,  memb_deltaF_PUCCH_f1_constraint_1 },
		0, 0, /* No default value */
		"deltaF-PUCCH-f1"
		},
	{ ATF_POINTER, 6, offsetof(struct PUCCH_PowerControl, deltaF_PUCCH_f2),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_deltaF_PUCCH_f2_constr_4,  memb_deltaF_PUCCH_f2_constraint_1 },
		0, 0, /* No default value */
		"deltaF-PUCCH-f2"
		},
	{ ATF_POINTER, 5, offsetof(struct PUCCH_PowerControl, deltaF_PUCCH_f3),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_deltaF_PUCCH_f3_constr_5,  memb_deltaF_PUCCH_f3_constraint_1 },
		0, 0, /* No default value */
		"deltaF-PUCCH-f3"
		},
	{ ATF_POINTER, 4, offsetof(struct PUCCH_PowerControl, deltaF_PUCCH_f4),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_deltaF_PUCCH_f4_constr_6,  memb_deltaF_PUCCH_f4_constraint_1 },
		0, 0, /* No default value */
		"deltaF-PUCCH-f4"
		},
	{ ATF_POINTER, 3, offsetof(struct PUCCH_PowerControl, p0_Set),
		...
		&asn_DEF_p0_Set_7,
		0,
		{ 0, &asn_PER_memb_p0_Set_constr_7,  memb_p0_Set_constraint_1 },
		0, 0, /* No default value */
		"p0-Set"
		},
	{ ATF_POINTER, 2, offsetof(struct PUCCH_PowerControl, pathlossReferenceRSs),
		...
		0,
		{ 0, &asn_PER_memb_pathlossReferenceRSs_constr_9,  memb_pathlossReferenceRSs_constraint_1 },
		0, 0, /* No default value */
		"pathlossReferenceRSs"
		},
