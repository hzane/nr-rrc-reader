...
asn_TYPE_member_t asn_MBR_BandParameters_1[] = {
	{ ATF_POINTER, 0, offsetof(struct BandParameters, eutra),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_eutra_2,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct BandParameters, nr),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_nr_6,
		0,
...
asn_TYPE_descriptor_t asn_DEF_BandParameters = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_BandParameters_constr_1, CHOICE_constraint },
