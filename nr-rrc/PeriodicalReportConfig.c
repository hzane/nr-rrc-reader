...
asn_TYPE_descriptor_t asn_DEF_reportAmount_4 = {
	...
	{ 0, &asn_PER_type_reportAmount_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_PeriodicalReportConfig_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PeriodicalReportConfig, maxReportCells),
		...
		0,
		{ 0, &asn_PER_memb_maxReportCells_constr_14,  memb_maxReportCells_constraint_1 },
		0, 0, /* No default value */
		"maxReportCells"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct PeriodicalReportConfig, maxNrofRS_IndexesToReport),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNrofRS_IndexesToReport_constr_16,  memb_maxNrofRS_IndexesToReport_constraint_1 },
		0, 0, /* No default value */
