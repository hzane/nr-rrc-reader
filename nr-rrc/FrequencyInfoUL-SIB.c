...
asn_TYPE_descriptor_t asn_DEF_scs_SpecificCarrierList_4 = {
	...
	{ 0, &asn_PER_type_scs_SpecificCarrierList_constr_4, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_frequencyShift7p5khz_7 = {
	...
	{ 0, &asn_PER_type_frequencyShift7p5khz_constr_7, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_FrequencyInfoUL_SIB_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct FrequencyInfoUL_SIB, scs_SpecificCarrierList),
		...
		0,
		{ 0, &asn_PER_memb_scs_SpecificCarrierList_constr_4,  memb_scs_SpecificCarrierList_constraint_1 },
		0, 0, /* No default value */
		"scs-SpecificCarrierList"
		},
