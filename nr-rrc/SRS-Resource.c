...
asn_TYPE_descriptor_t asn_DEF_ptrs_PortIndex_7 = {
	...
	{ 0, &asn_PER_type_ptrs_PortIndex_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_n2_11[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resource__transmissionComb__n2, combOffset_n2),
		...
		0,
		{ 0, &asn_PER_memb_combOffset_n2_constr_12,  memb_combOffset_n2_constraint_11 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resource__transmissionComb__n2, cyclicShift_n2),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_cyclicShift_n2_constr_13,  memb_cyclicShift_n2_constraint_11 },
		0, 0, /* No default value */
		"cyclicShift-n2"
		},
};
...
static asn_TYPE_member_t asn_MBR_n4_14[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resource__transmissionComb__n4, combOffset_n4),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_combOffset_n4_constr_15,  memb_combOffset_n4_constraint_14 },
		0, 0, /* No default value */
		"combOffset-n4"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resource__transmissionComb__n4, cyclicShift_n4),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_cyclicShift_n4_constr_16,  memb_cyclicShift_n4_constraint_14 },
		0, 0, /* No default value */
		"cyclicShift-n4"
		},
};
...
static asn_TYPE_member_t asn_MBR_transmissionComb_10[] = {
	{ ATF_POINTER, 0, offsetof(struct SRS_Resource__transmissionComb, n2),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_n2_11,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SRS_Resource__transmissionComb, n4),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_n4_14,
		0,
...
asn_TYPE_descriptor_t asn_DEF_transmissionComb_10 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_transmissionComb_constr_10, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_nrofSymbols_19 = {
	...
	{ 0, &asn_PER_type_nrofSymbols_constr_19, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_repetitionFactor_23 = {
	...
	{ 0, &asn_PER_type_repetitionFactor_constr_23, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_resourceMapping_17[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resource__resourceMapping, startPosition),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_startPosition_constr_18,  memb_startPosition_constraint_17 },
		0, 0, /* No default value */
		"startPosition"
		},
...
static asn_TYPE_member_t asn_MBR_freqHopping_29[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resource__freqHopping, c_SRS),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_c_SRS_constr_30,  memb_c_SRS_constraint_29 },
		0, 0, /* No default value */
		"c-SRS"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resource__freqHopping, b_SRS),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_b_SRS_constr_31,  memb_b_SRS_constraint_29 },
		0, 0, /* No default value */
		"b-SRS"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resource__freqHopping, b_hop),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_b_hop_constr_32,  memb_b_hop_constraint_29 },
		0, 0, /* No default value */
		"b-hop"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_groupOrSequenceHopping_33 = {
	...
	{ 0, &asn_PER_type_groupOrSequenceHopping_constr_33, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_resourceType_37[] = {
	{ ATF_POINTER, 0, offsetof(struct SRS_Resource__resourceType, aperiodic),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SRS_Resource__resourceType, semi_persistent),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SRS_Resource__resourceType, periodic),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_periodic_43,
		0,
...
asn_TYPE_descriptor_t asn_DEF_resourceType_37 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_resourceType_constr_37, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_SRS_Resource_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resource, freqDomainPosition),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_freqDomainPosition_constr_27,  memb_freqDomainPosition_constraint_1 },
		0, 0, /* No default value */
		"freqDomainPosition"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resource, freqDomainShift),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_freqDomainShift_constr_28,  memb_freqDomainShift_constraint_1 },
		0, 0, /* No default value */
		"freqDomainShift"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resource, sequenceId),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_sequenceId_constr_46,  memb_sequenceId_constraint_1 },
		0, 0, /* No default value */
		"sequenceId"
		},
