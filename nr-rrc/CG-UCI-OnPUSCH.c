...
asn_TYPE_descriptor_t asn_DEF_dynamic_2 = {
	...
	{ 0, &asn_PER_type_dynamic_constr_2, SEQUENCE_OF_constraint },
	asn_MBR_dynamic_2,
	1,	/* Single element */
...
asn_TYPE_member_t asn_MBR_CG_UCI_OnPUSCH_1[] = {
	{ ATF_POINTER, 0, offsetof(struct CG_UCI_OnPUSCH, dynamic),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_dynamic_2,
		0,
		{ 0, &asn_PER_memb_dynamic_constr_2,  memb_dynamic_constraint_1 },
		0, 0, /* No default value */
		"dynamic"
		},
	{ ATF_POINTER, 0, offsetof(struct CG_UCI_OnPUSCH, semiStatic),
...
asn_TYPE_descriptor_t asn_DEF_CG_UCI_OnPUSCH = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_CG_UCI_OnPUSCH_constr_1, CHOICE_constraint },
