...
static asn_TYPE_member_t asn_MBR_cnAssociation_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DRB_ToAddMod__cnAssociation, eps_BearerIdentity),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_eps_BearerIdentity_constr_3,  memb_eps_BearerIdentity_constraint_2 },
		0, 0, /* No default value */
		"eps-BearerIdentity"
		},
	{ ATF_POINTER, 0, offsetof(struct DRB_ToAddMod__cnAssociation, sdap_Config),
...
asn_TYPE_descriptor_t asn_DEF_cnAssociation_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_cnAssociation_constr_2, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_reestablishPDCP_6 = {
	...
	{ 0, &asn_PER_type_reestablishPDCP_constr_6, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_recoverPDCP_8 = {
	...
	{ 0, &asn_PER_type_recoverPDCP_constr_8, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
