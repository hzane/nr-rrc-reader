...
asn_TYPE_descriptor_t asn_DEF_selectedBandEntriesMN_14 = {
	...
	{ 0, &asn_PER_type_selectedBandEntriesMN_constr_14, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_ext1_13[] = {
	{ ATF_POINTER, 3, offsetof(struct ConfigRestrictInfoSCG__ext1, selectedBandEntriesMN),
		...
		0,
		{ 0, &asn_PER_memb_selectedBandEntriesMN_constr_14,  memb_selectedBandEntriesMN_constraint_13 },
		0, 0, /* No default value */
		"selectedBandEntriesMN"
		},
	{ ATF_POINTER, 2, offsetof(struct ConfigRestrictInfoSCG__ext1, pdcch_BlindDetectionSCG),
		...
		0,
		{ 0, &asn_PER_memb_pdcch_BlindDetectionSCG_constr_16,  memb_pdcch_BlindDetectionSCG_constraint_13 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct ConfigRestrictInfoSCG__ext1, maxNumberROHC_ContextSessionsSN),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberROHC_ContextSessionsSN_constr_17,  memb_maxNumberROHC_ContextSessionsSN_constraint_13 },
		0, 0, /* No default value */
...
asn_TYPE_member_t asn_MBR_ConfigRestrictInfoSCG_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct ConfigRestrictInfoSCG, maxMeasFreqsSCG),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxMeasFreqsSCG_constr_10,  memb_maxMeasFreqsSCG_constraint_1 },
		0, 0, /* No default value */
		"maxMeasFreqsSCG"
		},
	{ ATF_POINTER, 2, offsetof(struct ConfigRestrictInfoSCG, maxMeasIdentitiesSCG_NR),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxMeasIdentitiesSCG_NR_constr_11,  memb_maxMeasIdentitiesSCG_NR_constraint_1 },
		0, 0, /* No default value */
