...
static int
memb_selectedBandEntriesMN_constraint_13(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_pdcch_BlindDetectionSCG_constraint_13(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_maxNumberROHC_ContextSessionsSN_constraint_13(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_type_selectedBandEntriesMN_constr_14 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
static asn_per_constraints_t asn_PER_type_selectedBandEntriesMN_constr_14 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_selectedBandEntriesMN_constr_14 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
static asn_per_constraints_t asn_PER_memb_selectedBandEntriesMN_constr_14 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_pdcch_BlindDetectionSCG_constr_16 CC_NOTUSED = {
	{ 1, 1 }	/* (1..15) */,
	-1};
static asn_per_constraints_t asn_PER_memb_pdcch_BlindDetectionSCG_constr_16 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  1,  15 }	/* (1..15) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_maxNumberROHC_ContextSessionsSN_constr_17 CC_NOTUSED = {
	{ 2, 1 }	/* (0..16384) */,
	-1};
static asn_per_constraints_t asn_PER_memb_maxNumberROHC_ContextSessionsSN_constr_17 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_selectedBandEntriesMN_14[] = {
	{ ATF_POINTER, 0, 0,
...
static const ber_tlv_tag_t asn_DEF_selectedBandEntriesMN_tags_14[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_selectedBandEntriesMN_specs_14 = {
	sizeof(struct ConfigRestrictInfoSCG__ext1__selectedBandEntriesMN),
	offsetof(struct ConfigRestrictInfoSCG__ext1__selectedBandEntriesMN, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_selectedBandEntriesMN_14 = {
	"selectedBandEntriesMN",
	"selectedBandEntriesMN",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_selectedBandEntriesMN_tags_14,
	sizeof(asn_DEF_selectedBandEntriesMN_tags_14)
		/sizeof(asn_DEF_selectedBandEntriesMN_tags_14[0]) - 1, /* 1 */
	asn_DEF_selectedBandEntriesMN_tags_14,	/* Same as above */
	sizeof(asn_DEF_selectedBandEntriesMN_tags_14)
		/sizeof(asn_DEF_selectedBandEntriesMN_tags_14[0]), /* 2 */
	{ &asn_OER_type_selectedBandEntriesMN_constr_14, &asn_PER_type_selectedBandEntriesMN_constr_14, SEQUENCE_OF_constraint },
	asn_MBR_selectedBandEntriesMN_14,
	1,	/* Single element */
	&asn_SPC_selectedBandEntriesMN_specs_14	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_13[] = {
	{ ATF_POINTER, 3, offsetof(struct ConfigRestrictInfoSCG__ext1, selectedBandEntriesMN),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_selectedBandEntriesMN_14,
		0,
		{ &asn_OER_memb_selectedBandEntriesMN_constr_14, &asn_PER_memb_selectedBandEntriesMN_constr_14,  memb_selectedBandEntriesMN_constraint_13 },
		0, 0, /* No default value */
		"selectedBandEntriesMN"
		},
	{ ATF_POINTER, 2, offsetof(struct ConfigRestrictInfoSCG__ext1, pdcch_BlindDetectionSCG),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_pdcch_BlindDetectionSCG_constr_16, &asn_PER_memb_pdcch_BlindDetectionSCG_constr_16,  memb_pdcch_BlindDetectionSCG_constraint_13 },
		0, 0, /* No default value */
		"pdcch-BlindDetectionSCG"
		},
	{ ATF_POINTER, 1, offsetof(struct ConfigRestrictInfoSCG__ext1, maxNumberROHC_ContextSessionsSN),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_maxNumberROHC_ContextSessionsSN_constr_17, &asn_PER_memb_maxNumberROHC_ContextSessionsSN_constr_17,  memb_maxNumberROHC_ContextSessionsSN_constraint_13 },
		0, 0, /* No default value */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_13 = {
	sizeof(struct ConfigRestrictInfoSCG__ext1),
	offsetof(struct ConfigRestrictInfoSCG__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_ConfigRestrictInfoSCG_1[] = {
	{ ATF_POINTER, 6, offsetof(struct ConfigRestrictInfoSCG, allowedBC_ListMRDC),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct ConfigRestrictInfoSCG, powerCoordination_FR1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct ConfigRestrictInfoSCG, servCellIndexRangeSCG),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct ConfigRestrictInfoSCG, maxMeasFreqsSCG),
	...
	{ ATF_POINTER, 2, offsetof(struct ConfigRestrictInfoSCG, maxMeasIdentitiesSCG_NR),
	...
	{ ATF_POINTER, 1, offsetof(struct ConfigRestrictInfoSCG, ext1),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext1_13,
		0,
...
static const int asn_MAP_ConfigRestrictInfoSCG_oms_1[] = { 0, 1, 2, 3, 4, 5 };
