...
asn_TYPE_descriptor_t asn_DEF_connEstFailCount_2 = {
	...
	{ 0, &asn_PER_type_connEstFailCount_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_connEstFailOffsetValidity_7 = {
	...
	{ 0, &asn_PER_type_connEstFailOffsetValidity_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_ConnEstFailureControl_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ConnEstFailureControl, connEstFailOffset),
		...
		0,
		{ 0, &asn_PER_memb_connEstFailOffset_constr_16,  memb_connEstFailOffset_constraint_1 },
		0, 0, /* No default value */
		"connEstFailOffset"
		},
};
