...
asn_TYPE_descriptor_t asn_DEF_sdap_HeaderDL_3 = {
	...
	{ 0, &asn_PER_type_sdap_HeaderDL_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_sdap_HeaderUL_6 = {
	...
	{ 0, &asn_PER_type_sdap_HeaderUL_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_mappedQoS_FlowsToAdd_10 = {
	...
	{ 0, &asn_PER_type_mappedQoS_FlowsToAdd_constr_10, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_mappedQoS_FlowsToRelease_12 = {
	...
	{ 0, &asn_PER_type_mappedQoS_FlowsToRelease_constr_12, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_SDAP_Config_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct SDAP_Config, mappedQoS_FlowsToAdd),
		...
		0,
		{ 0, &asn_PER_memb_mappedQoS_FlowsToAdd_constr_10,  memb_mappedQoS_FlowsToAdd_constraint_1 },
		0, 0, /* No default value */
		"mappedQoS-FlowsToAdd"
		},
	{ ATF_POINTER, 1, offsetof(struct SDAP_Config, mappedQoS_FlowsToRelease),
		...
		0,
		{ 0, &asn_PER_memb_mappedQoS_FlowsToRelease_constr_12,  memb_mappedQoS_FlowsToRelease_constraint_1 },
		0, 0, /* No default value */
		"mappedQoS-FlowsToRelease"
		},
};
