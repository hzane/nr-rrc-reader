...
asn_TYPE_member_t asn_MBR_CarrierFreqEUTRA_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqEUTRA, q_RxLevMin),
		...
		0,
		{ 0, &asn_PER_memb_q_RxLevMin_constr_12,  memb_q_RxLevMin_constraint_1 },
		0, 0, /* No default value */
		"q-RxLevMin"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqEUTRA, q_QualMin),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_q_QualMin_constr_13,  memb_q_QualMin_constraint_1 },
		0, 0, /* No default value */
		"q-QualMin"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqEUTRA, p_MaxEUTRA),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_p_MaxEUTRA_constr_14,  memb_p_MaxEUTRA_constraint_1 },
		0, 0, /* No default value */
		"p-MaxEUTRA"
		},
