...
static asn_TYPE_member_t asn_MBR_frequencyDomainAllocation_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ResourceMapping__frequencyDomainAllocation, row1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_row1_constr_3,  memb_row1_constraint_2 },
		0, 0, /* No default value */
		"row1"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ResourceMapping__frequencyDomainAllocation, row2),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_row2_constr_4,  memb_row2_constraint_2 },
		0, 0, /* No default value */
		"row2"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ResourceMapping__frequencyDomainAllocation, row4),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_row4_constr_5,  memb_row4_constraint_2 },
		0, 0, /* No default value */
		"row4"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ResourceMapping__frequencyDomainAllocation, other),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_other_constr_6,  memb_other_constraint_2 },
		0, 0, /* No default value */
		"other"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_frequencyDomainAllocation_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_frequencyDomainAllocation_constr_2, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_nrofPorts_7 = {
	...
	{ 0, &asn_PER_type_nrofPorts_constr_7, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_cdm_Type_18 = {
	...
	{ 0, &asn_PER_type_cdm_Type_constr_18, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_dot5_24 = {
	...
	{ 0, &asn_PER_type_dot5_constr_24, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_dot5_specs_24	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_density_23[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ResourceMapping__density, dot5),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_dot5_24,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ResourceMapping__density, one),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ResourceMapping__density, three),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ResourceMapping__density, spare),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
...
asn_TYPE_descriptor_t asn_DEF_density_23 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_density_constr_23, CHOICE_constraint },
	asn_MBR_density_23,
	4,	/* Elements count */
...
asn_TYPE_member_t asn_MBR_CSI_RS_ResourceMapping_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ResourceMapping, firstOFDMSymbolInTimeDomain),
		...
		0,
		{ 0, &asn_PER_memb_firstOFDMSymbolInTimeDomain_constr_16,  memb_firstOFDMSymbolInTimeDomain_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct CSI_RS_ResourceMapping, firstOFDMSymbolInTimeDomain2),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_firstOFDMSymbolInTimeDomain2_constr_17,  memb_firstOFDMSymbolInTimeDomain2_constraint_1 },
		0, 0, /* No default value */
