...
static asn_TYPE_member_t asn_MBR_s_MeasureConfig_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct VarMeasConfig__s_MeasureConfig, ssb_RSRP),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VarMeasConfig__s_MeasureConfig, csi_RSRP),
...
asn_TYPE_descriptor_t asn_DEF_s_MeasureConfig_6 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_s_MeasureConfig_constr_6, CHOICE_constraint },
