...
asn_TYPE_descriptor_t asn_DEF_frequencyDensity_2 = {
	...
	{ 0, &asn_PER_type_frequencyDensity_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_timeDensity_4 = {
	...
	{ 0, &asn_PER_type_timeDensity_constr_4, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_resourceElementOffset_7 = {
	...
	{ 0, &asn_PER_type_resourceElementOffset_constr_7, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_PTRS_DownlinkConfig_1[] = {
	{ ATF_POINTER, 4, offsetof(struct PTRS_DownlinkConfig, frequencyDensity),
		...
		0,
		{ 0, &asn_PER_memb_frequencyDensity_constr_2,  memb_frequencyDensity_constraint_1 },
		0, 0, /* No default value */
		"frequencyDensity"
		},
	{ ATF_POINTER, 3, offsetof(struct PTRS_DownlinkConfig, timeDensity),
		...
		0,
		{ 0, &asn_PER_memb_timeDensity_constr_4,  memb_timeDensity_constraint_1 },
		0, 0, /* No default value */
		"timeDensity"
		},
	{ ATF_POINTER, 2, offsetof(struct PTRS_DownlinkConfig, epre_Ratio),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_epre_Ratio_constr_6,  memb_epre_Ratio_constraint_1 },
		0, 0, /* No default value */
		"epre-Ratio"
		},
