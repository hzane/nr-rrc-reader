...
static asn_TYPE_member_t asn_MBR_referenceSignal_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct QCL_Info__referenceSignal, csi_rs),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct QCL_Info__referenceSignal, ssb),
...
asn_TYPE_descriptor_t asn_DEF_qcl_Type_7 = {
	...
	{ 0, &asn_PER_type_qcl_Type_constr_7, NativeEnumerated_constraint },
