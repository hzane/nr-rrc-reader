...
static asn_TYPE_member_t asn_MBR_cellSelectionInfo_2[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct SIB1__cellSelectionInfo, q_RxLevMinOffset),
		...
		0,
		{ 0, &asn_PER_memb_q_RxLevMinOffset_constr_4,  memb_q_RxLevMinOffset_constraint_2 },
		0, 0, /* No default value */
		"q-RxLevMinOffset"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct SIB1__cellSelectionInfo, q_QualMinOffset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_q_QualMinOffset_constr_7,  memb_q_QualMinOffset_constraint_2 },
		0, 0, /* No default value */
		"q-QualMinOffset"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_ims_EmergencySupport_12 = {
	...
	{ 0, &asn_PER_type_ims_EmergencySupport_constr_12, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_eCallOverIMS_Support_14 = {
	...
	{ 0, &asn_PER_type_eCallOverIMS_Support_constr_14, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_individualPLMNList_23 = {
	...
	{ 0, &asn_PER_type_individualPLMNList_constr_23, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_uac_AccessCategory1_SelectionAssistanceInfo_21[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SIB1__uac_BarringInfo__uac_AccessCategory1_SelectionAssistanceInfo, plmnCommon),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_UAC_AccessCategory1_SelectionAssistanceInfo,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SIB1__uac_BarringInfo__uac_AccessCategory1_SelectionAssistanceInfo, individualPLMNList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_individualPLMNList_23,
		0,
		{ 0, &asn_PER_memb_individualPLMNList_constr_23,  memb_individualPLMNList_constraint_21 },
		0, 0, /* No default value */
		"individualPLMNList"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_uac_AccessCategory1_SelectionAssistanceInfo_21 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_uac_AccessCategory1_SelectionAssistanceInfo_constr_21, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_useFullResumeID_25 = {
	...
	{ 0, &asn_PER_type_useFullResumeID_constr_25, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
