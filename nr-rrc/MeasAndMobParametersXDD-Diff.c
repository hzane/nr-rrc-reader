...
static asn_oer_constraints_t asn_OER_type_handoverLTE_EPC_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_handoverLTE_EPC_constr_10 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_handoverLTE_5GC_constr_12 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_handoverLTE_5GC_constr_12 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_handoverLTE_EPC_value2enum_10[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_handoverLTE_EPC_enum2value_10[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_handoverLTE_EPC_specs_10 = {
	asn_MAP_handoverLTE_EPC_value2enum_10,	/* "tag" => N; sorted by tag */
	asn_MAP_handoverLTE_EPC_enum2value_10,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_handoverLTE_EPC_tags_10[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_handoverLTE_EPC_10 = {
	"handoverLTE-EPC",
	"handoverLTE-EPC",
	&asn_OP_NativeEnumerated,
	asn_DEF_handoverLTE_EPC_tags_10,
	sizeof(asn_DEF_handoverLTE_EPC_tags_10)
		/sizeof(asn_DEF_handoverLTE_EPC_tags_10[0]) - 1, /* 1 */
	asn_DEF_handoverLTE_EPC_tags_10,	/* Same as above */
	sizeof(asn_DEF_handoverLTE_EPC_tags_10)
		/sizeof(asn_DEF_handoverLTE_EPC_tags_10[0]), /* 2 */
	{ &asn_OER_type_handoverLTE_EPC_constr_10, &asn_PER_type_handoverLTE_EPC_constr_10, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_handoverLTE_EPC_specs_10	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_handoverLTE_5GC_value2enum_12[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_handoverLTE_5GC_enum2value_12[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_handoverLTE_5GC_specs_12 = {
	asn_MAP_handoverLTE_5GC_value2enum_12,	/* "tag" => N; sorted by tag */
	asn_MAP_handoverLTE_5GC_enum2value_12,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_handoverLTE_5GC_tags_12[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_handoverLTE_5GC_12 = {
	"handoverLTE-5GC",
	"handoverLTE-5GC",
	&asn_OP_NativeEnumerated,
	asn_DEF_handoverLTE_5GC_tags_12,
	sizeof(asn_DEF_handoverLTE_5GC_tags_12)
		/sizeof(asn_DEF_handoverLTE_5GC_tags_12[0]) - 1, /* 1 */
	asn_DEF_handoverLTE_5GC_tags_12,	/* Same as above */
	sizeof(asn_DEF_handoverLTE_5GC_tags_12)
		/sizeof(asn_DEF_handoverLTE_5GC_tags_12[0]), /* 2 */
	{ &asn_OER_type_handoverLTE_5GC_constr_12, &asn_PER_type_handoverLTE_5GC_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_handoverLTE_5GC_specs_12	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_ext1_7[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct MeasAndMobParametersXDD_Diff__ext1, handoverLTE_EPC),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_handoverLTE_EPC_10,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"handoverLTE-EPC"
		},
	{ ATF_POINTER, 1, offsetof(struct MeasAndMobParametersXDD_Diff__ext1, handoverLTE_5GC),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_handoverLTE_5GC_12,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"handoverLTE-5GC"
