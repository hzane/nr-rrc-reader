...
asn_TYPE_descriptor_t asn_DEF_commonSearchSpaceList_5 = {
	...
	{ 0, &asn_PER_type_commonSearchSpaceList_constr_5, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_firstPDCCH_MonitoringOccasionOfPO_13[] = {
	{ ATF_POINTER, 0, offsetof(struct PDCCH_ConfigCommon__ext1__firstPDCCH_MonitoringOccasionOfPO, sCS15KHZoneT),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct PDCCH_ConfigCommon__ext1__firstPDCCH_MonitoringOccasionOfPO, sCS30KHZoneT_SCS15KHZhalfT),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct PDCCH_ConfigCommon__ext1__firstPDCCH_MonitoringOccasionOfPO, sCS60KHZoneT_SCS30KHZhalfT_SCS15KHZquarterT),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct PDCCH_ConfigCommon__ext1__firstPDCCH_MonitoringOccasionOfPO, sCS120KHZoneT_SCS60KHZhalfT_SCS30KHZquarterT_SCS15KHZoneEighthT),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct PDCCH_ConfigCommon__ext1__firstPDCCH_MonitoringOccasionOfPO, sCS120KHZhalfT_SCS60KHZquarterT_SCS30KHZoneEighthT_SCS15KHZoneSixteenthT),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct PDCCH_ConfigCommon__ext1__firstPDCCH_MonitoringOccasionOfPO, sCS120KHZquarterT_SCS60KHZoneEighthT_SCS30KHZoneSixteenthT),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct PDCCH_ConfigCommon__ext1__firstPDCCH_MonitoringOccasionOfPO, sCS120KHZoneEighthT_SCS60KHZoneSixteenthT),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct PDCCH_ConfigCommon__ext1__firstPDCCH_MonitoringOccasionOfPO, sCS120KHZoneSixteenthT),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
...
asn_TYPE_member_t asn_MBR_PDCCH_ConfigCommon_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct PDCCH_ConfigCommon, commonSearchSpaceList),
		...
		0,
		{ 0, &asn_PER_memb_commonSearchSpaceList_constr_5,  memb_commonSearchSpaceList_constraint_1 },
		0, 0, /* No default value */
		"commonSearchSpaceList"
		},
