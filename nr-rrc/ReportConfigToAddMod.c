...
static asn_TYPE_member_t asn_MBR_reportConfig_3[] = {
	{ ATF_POINTER, 0, offsetof(struct ReportConfigToAddMod__reportConfig, reportConfigNR),
	...
	{ ATF_POINTER, 0, offsetof(struct ReportConfigToAddMod__reportConfig, reportConfigInterRAT),
