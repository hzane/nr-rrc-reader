...
asn_TYPE_descriptor_t asn_DEF_dynamic_3 = {
	...
	{ 0, &asn_PER_type_dynamic_constr_3, SEQUENCE_OF_constraint },
	asn_MBR_dynamic_3,
	1,	/* Single element */
...
static asn_TYPE_member_t asn_MBR_betaOffsets_2[] = {
	{ ATF_POINTER, 0, offsetof(struct UCI_OnPUSCH__betaOffsets, dynamic),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_dynamic_3,
		0,
		{ 0, &asn_PER_memb_dynamic_constr_3,  memb_dynamic_constraint_2 },
		0, 0, /* No default value */
		"dynamic"
		},
	{ ATF_POINTER, 0, offsetof(struct UCI_OnPUSCH__betaOffsets, semiStatic),
...
asn_TYPE_descriptor_t asn_DEF_betaOffsets_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_betaOffsets_constr_2, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_scaling_6 = {
	...
	{ 0, &asn_PER_type_scaling_constr_6, NativeEnumerated_constraint },
