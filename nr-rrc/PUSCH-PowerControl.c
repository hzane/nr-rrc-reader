...
asn_TYPE_descriptor_t asn_DEF_tpc_Accumulation_2 = {
	...
	{ 0, &asn_PER_type_tpc_Accumulation_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_p0_AlphaSets_6 = {
	...
	{ 0, &asn_PER_type_p0_AlphaSets_constr_6, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_pathlossReferenceRSToAddModList_8 = {
	...
	{ 0, &asn_PER_type_pathlossReferenceRSToAddModList_constr_8, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_pathlossReferenceRSToReleaseList_10 = {
	...
	{ 0, &asn_PER_type_pathlossReferenceRSToReleaseList_constr_10, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_twoPUSCH_PC_AdjustmentStates_12 = {
	...
	{ 0, &asn_PER_type_twoPUSCH_PC_AdjustmentStates_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_deltaMCS_14 = {
	...
	{ 0, &asn_PER_type_deltaMCS_constr_14, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_sri_PUSCH_MappingToAddModList_16 = {
	...
	{ 0, &asn_PER_type_sri_PUSCH_MappingToAddModList_constr_16, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_sri_PUSCH_MappingToReleaseList_18 = {
	...
	{ 0, &asn_PER_type_sri_PUSCH_MappingToReleaseList_constr_18, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_PUSCH_PowerControl_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct PUSCH_PowerControl, p0_NominalWithoutGrant),
		...
		0,
		{ 0, &asn_PER_memb_p0_NominalWithoutGrant_constr_5,  memb_p0_NominalWithoutGrant_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 7, offsetof(struct PUSCH_PowerControl, p0_AlphaSets),
		...
		0,
		{ 0, &asn_PER_memb_p0_AlphaSets_constr_6,  memb_p0_AlphaSets_constraint_1 },
		0, 0, /* No default value */
		"p0-AlphaSets"
		},
	{ ATF_POINTER, 6, offsetof(struct PUSCH_PowerControl, pathlossReferenceRSToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_pathlossReferenceRSToAddModList_constr_8,  memb_pathlossReferenceRSToAddModList_constraint_1 },
		0, 0, /* No default value */
		"pathlossReferenceRSToAddModList"
		},
	{ ATF_POINTER, 5, offsetof(struct PUSCH_PowerControl, pathlossReferenceRSToReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_pathlossReferenceRSToReleaseList_constr_10,  memb_pathlossReferenceRSToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"pathlossReferenceRSToReleaseList"
		},
	...
	{ ATF_POINTER, 2, offsetof(struct PUSCH_PowerControl, sri_PUSCH_MappingToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_sri_PUSCH_MappingToAddModList_constr_16,  memb_sri_PUSCH_MappingToAddModList_constraint_1 },
		0, 0, /* No default value */
		"sri-PUSCH-MappingToAddModList"
		},
	{ ATF_POINTER, 1, offsetof(struct PUSCH_PowerControl, sri_PUSCH_MappingToReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_sri_PUSCH_MappingToReleaseList_constr_18,  memb_sri_PUSCH_MappingToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"sri-PUSCH-MappingToReleaseList"
		},
};
