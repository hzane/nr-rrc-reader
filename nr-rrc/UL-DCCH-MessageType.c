...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, measurementReport),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, rrcReconfigurationComplete),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, rrcSetupComplete),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, rrcReestablishmentComplete),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, rrcResumeComplete),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, securityModeComplete),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, securityModeFailure),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, ulInformationTransfer),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, locationMeasurementIndication),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, ueCapabilityInformation),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, counterCheckResponse),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, ueAssistanceInformation),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, failureInformation),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, ulInformationTransferMRDC),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, scgFailureInformation),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__c1, scgFailureInformationEUTRA),
...
asn_TYPE_member_t asn_MBR_UL_DCCH_MessageType_1[] = {
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType, c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType, messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
