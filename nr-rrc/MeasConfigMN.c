...
asn_TYPE_descriptor_t asn_DEF_measuredFrequenciesMN_2 = {
	...
	{ 0, &asn_PER_type_measuredFrequenciesMN_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_gapPurpose_5 = {
	...
	{ 0, &asn_PER_type_gapPurpose_constr_5, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_gapPurpose_specs_5	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_9[] = {
	{ ATF_POINTER, 1, offsetof(struct MeasConfigMN__ext1, measGapConfigFR2),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_9 = {
	sizeof(struct MeasConfigMN__ext1),
	offsetof(struct MeasConfigMN__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_MeasConfigMN_1[] = {
	{ ATF_POINTER, 4, offsetof(struct MeasConfigMN, measuredFrequenciesMN),
		...
		0,
		{ 0, &asn_PER_memb_measuredFrequenciesMN_constr_2,  memb_measuredFrequenciesMN_constraint_1 },
		0, 0, /* No default value */
		"measuredFrequenciesMN"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct MeasConfigMN, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_9,
		0,
