...
asn_TYPE_descriptor_t asn_DEF_bandList_2 = {
	...
	{ 0, &asn_PER_type_bandList_constr_2, SEQUENCE_OF_constraint },
	asn_MBR_bandList_2,
	1,	/* Single element */
...
asn_TYPE_descriptor_t asn_DEF_powerClass_v1530_9 = {
	...
	{ 0, &asn_PER_type_powerClass_v1530_constr_9, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_BandCombination_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct BandCombination, bandList),
		...
		&asn_DEF_bandList_2,
		0,
		{ 0, &asn_PER_memb_bandList_constr_2,  memb_bandList_constraint_1 },
		0, 0, /* No default value */
		"bandList"
		},
	...
	{ ATF_POINTER, 2, offsetof(struct BandCombination, supportedBandwidthCombinationSet),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_supportedBandwidthCombinationSet_constr_8,  memb_supportedBandwidthCombinationSet_constraint_1 },
		0, 0, /* No default value */
