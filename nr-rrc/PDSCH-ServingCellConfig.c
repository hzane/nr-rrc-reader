...
static asn_oer_constraints_t asn_OER_memb_maxMIMO_Layers_constr_17 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_ext1_16[] = {
	{ ATF_POINTER, 2, offsetof(struct PDSCH_ServingCellConfig__ext1, maxMIMO_Layers),
		...
		0,
		{ &asn_OER_memb_maxMIMO_Layers_constr_17, &asn_PER_memb_maxMIMO_Layers_constr_17,  memb_maxMIMO_Layers_constraint_16 },
