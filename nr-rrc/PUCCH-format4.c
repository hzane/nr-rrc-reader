...
asn_TYPE_descriptor_t asn_DEF_occ_Length_3 = {
	...
	{ 0, &asn_PER_type_occ_Length_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_occ_Index_6 = {
	...
	{ 0, &asn_PER_type_occ_Index_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_PUCCH_format4_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_format4, nrofSymbols),
		...
		0,
		{ 0, &asn_PER_memb_nrofSymbols_constr_2,  memb_nrofSymbols_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_format4, startingSymbolIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_startingSymbolIndex_constr_11,  memb_startingSymbolIndex_constraint_1 },
		0, 0, /* No default value */
		"startingSymbolIndex"
		},
};
