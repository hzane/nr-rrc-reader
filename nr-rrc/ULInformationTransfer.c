...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_POINTER, 0, offsetof(struct ULInformationTransfer__criticalExtensions, ulInformationTransfer),
	...
	{ ATF_POINTER, 0, offsetof(struct ULInformationTransfer__criticalExtensions, criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
