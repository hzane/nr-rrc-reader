...
asn_TYPE_descriptor_t asn_DEF_fullConfig_3 = {
	...
	{ 0, &asn_PER_type_fullConfig_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_dedicatedNAS_MessageList_5 = {
	...
	{ 0, &asn_PER_type_dedicatedNAS_MessageList_constr_5, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_RRCReconfiguration_v1530_IEs_1[] = {
	{ ATF_POINTER, 8, offsetof(struct RRCReconfiguration_v1530_IEs, masterCellGroup),
		...
		0,
		{ 0, &asn_PER_memb_masterCellGroup_constr_2,  memb_masterCellGroup_constraint_1 },
		0, 0, /* No default value */
		"masterCellGroup"
		},
	...
	{ ATF_POINTER, 6, offsetof(struct RRCReconfiguration_v1530_IEs, dedicatedNAS_MessageList),
		...
		0,
		{ 0, &asn_PER_memb_dedicatedNAS_MessageList_constr_5,  memb_dedicatedNAS_MessageList_constraint_1 },
		0, 0, /* No default value */
		"dedicatedNAS-MessageList"
		},
	...
	{ ATF_POINTER, 4, offsetof(struct RRCReconfiguration_v1530_IEs, dedicatedSIB1_Delivery),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_dedicatedSIB1_Delivery_constr_8,  memb_dedicatedSIB1_Delivery_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 3, offsetof(struct RRCReconfiguration_v1530_IEs, dedicatedSystemInformationDelivery),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_dedicatedSystemInformationDelivery_constr_9,  memb_dedicatedSystemInformationDelivery_constraint_1 },
		0, 0, /* No default value */
