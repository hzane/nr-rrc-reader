...
asn_TYPE_member_t asn_MBR_BetaOffsets_1[] = {
	{ ATF_POINTER, 7, offsetof(struct BetaOffsets, betaOffsetACK_Index1),
		...
		0,
		{ 0, &asn_PER_memb_betaOffsetACK_Index1_constr_2,  memb_betaOffsetACK_Index1_constraint_1 },
	...
	{ ATF_POINTER, 6, offsetof(struct BetaOffsets, betaOffsetACK_Index2),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_betaOffsetACK_Index2_constr_3,  memb_betaOffsetACK_Index2_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 5, offsetof(struct BetaOffsets, betaOffsetACK_Index3),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_betaOffsetACK_Index3_constr_4,  memb_betaOffsetACK_Index3_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 4, offsetof(struct BetaOffsets, betaOffsetCSI_Part1_Index1),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_betaOffsetCSI_Part1_Index1_constr_5,  memb_betaOffsetCSI_Part1_Index1_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 3, offsetof(struct BetaOffsets, betaOffsetCSI_Part1_Index2),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_betaOffsetCSI_Part1_Index2_constr_6,  memb_betaOffsetCSI_Part1_Index2_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct BetaOffsets, betaOffsetCSI_Part2_Index1),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_betaOffsetCSI_Part2_Index1_constr_7,  memb_betaOffsetCSI_Part2_Index1_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct BetaOffsets, betaOffsetCSI_Part2_Index2),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_betaOffsetCSI_Part2_Index2_constr_8,  memb_betaOffsetCSI_Part2_Index2_constraint_1 },
		0, 0, /* No default value */
