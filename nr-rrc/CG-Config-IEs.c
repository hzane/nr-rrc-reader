...
asn_TYPE_member_t asn_MBR_CG_Config_IEs_1[] = {
	{ ATF_POINTER, 10, offsetof(struct CG_Config_IEs, scg_CellGroupConfig),
		...
		0,
		{ 0, &asn_PER_memb_scg_CellGroupConfig_constr_2,  memb_scg_CellGroupConfig_constraint_1 },
	...
	{ ATF_POINTER, 9, offsetof(struct CG_Config_IEs, scg_RB_Config),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_scg_RB_Config_constr_3,  memb_scg_RB_Config_constraint_1 },
		0, 0, /* No default value */
		"scg-RB-Config"
		},
	...
	{ ATF_POINTER, 6, offsetof(struct CG_Config_IEs, candidateCellInfoListSN),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_candidateCellInfoListSN_constr_6,  memb_candidateCellInfoListSN_constraint_1 },
		0, 0, /* No default value */
