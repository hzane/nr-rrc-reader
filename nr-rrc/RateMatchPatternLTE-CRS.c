...
asn_TYPE_descriptor_t asn_DEF_carrierBandwidthDL_3 = {
	...
	{ 0, &asn_PER_type_carrierBandwidthDL_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_nrofCRS_Ports_13 = {
	...
	{ 0, &asn_PER_type_nrofCRS_Ports_constr_13, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_v_Shift_17 = {
	...
	{ 0, &asn_PER_type_v_Shift_constr_17, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_RateMatchPatternLTE_CRS_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPatternLTE_CRS, carrierFreqDL),
		...
		0,
		{ 0, &asn_PER_memb_carrierFreqDL_constr_2,  memb_carrierFreqDL_constraint_1 },
