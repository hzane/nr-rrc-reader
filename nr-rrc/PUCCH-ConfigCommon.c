...
asn_TYPE_descriptor_t asn_DEF_pucch_GroupHopping_3 = {
	...
	{ 0, &asn_PER_type_pucch_GroupHopping_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_PUCCH_ConfigCommon_1[] = {
	{ ATF_POINTER, 1, offsetof(struct PUCCH_ConfigCommon, pucch_ResourceCommon),
		...
		0,
		{ 0, &asn_PER_memb_pucch_ResourceCommon_constr_2,  memb_pucch_ResourceCommon_constraint_1 },
	...
	{ ATF_POINTER, 2, offsetof(struct PUCCH_ConfigCommon, hoppingId),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_hoppingId_constr_7,  memb_hoppingId_constraint_1 },
		0, 0, /* No default value */
		"hoppingId"
		},
	{ ATF_POINTER, 1, offsetof(struct PUCCH_ConfigCommon, p0_nominal),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_p0_nominal_constr_8,  memb_p0_nominal_constraint_1 },
		0, 0, /* No default value */
		"p0-nominal"
		},
};
