...
asn_TYPE_member_t asn_MBR_MeasTriggerQuantityOffset_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MeasTriggerQuantityOffset, rsrp),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_rsrp_constr_2,  memb_rsrp_constraint_1 },
		0, 0, /* No default value */
		"rsrp"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct MeasTriggerQuantityOffset, rsrq),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_rsrq_constr_3,  memb_rsrq_constraint_1 },
		0, 0, /* No default value */
		"rsrq"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct MeasTriggerQuantityOffset, sinr),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_sinr_constr_4,  memb_sinr_constraint_1 },
		0, 0, /* No default value */
		"sinr"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_MeasTriggerQuantityOffset = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_MeasTriggerQuantityOffset_constr_1, CHOICE_constraint },
