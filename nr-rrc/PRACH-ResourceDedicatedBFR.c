...
asn_TYPE_member_t asn_MBR_PRACH_ResourceDedicatedBFR_1[] = {
	{ ATF_POINTER, 0, offsetof(struct PRACH_ResourceDedicatedBFR, ssb),
	...
	{ ATF_POINTER, 0, offsetof(struct PRACH_ResourceDedicatedBFR, csi_RS),
...
asn_TYPE_descriptor_t asn_DEF_PRACH_ResourceDedicatedBFR = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_PRACH_ResourceDedicatedBFR_constr_1, CHOICE_constraint },
