...
asn_TYPE_descriptor_t asn_DEF_powerControlOffsetSS_5 = {
	...
	{ 0, &asn_PER_type_powerControlOffsetSS_constr_5, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_NZP_CSI_RS_Resource_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NZP_CSI_RS_Resource, powerControlOffset),
		...
		0,
		{ 0, &asn_PER_memb_powerControlOffset_constr_4,  memb_powerControlOffset_constraint_1 },
		0, 0, /* No default value */
		"powerControlOffset"
		},
