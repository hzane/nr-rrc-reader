...
static asn_TYPE_member_t asn_MBR_referenceSignal_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_SpatialRelationInfo__referenceSignal, ssb_Index),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SSB_Index,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_SpatialRelationInfo__referenceSignal, csi_RS_Index),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 0, offsetof(struct SRS_SpatialRelationInfo__referenceSignal, srs),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_srs_6,
		0,
...
asn_TYPE_descriptor_t asn_DEF_referenceSignal_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_referenceSignal_constr_3, CHOICE_constraint },
