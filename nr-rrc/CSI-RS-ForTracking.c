...
asn_TYPE_member_t asn_MBR_CSI_RS_ForTracking_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ForTracking, maxBurstLength),
		...
		0,
		{ 0, &asn_PER_memb_maxBurstLength_constr_2,  memb_maxBurstLength_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ForTracking, maxSimultaneousResourceSetsPerCC),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxSimultaneousResourceSetsPerCC_constr_3,  memb_maxSimultaneousResourceSetsPerCC_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ForTracking, maxConfiguredResourceSetsPerCC),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxConfiguredResourceSetsPerCC_constr_4,  memb_maxConfiguredResourceSetsPerCC_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ForTracking, maxConfiguredResourceSetsAllCC),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxConfiguredResourceSetsAllCC_constr_5,  memb_maxConfiguredResourceSetsAllCC_constraint_1 },
		0, 0, /* No default value */
