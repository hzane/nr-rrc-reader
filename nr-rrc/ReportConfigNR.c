...
static asn_TYPE_member_t asn_MBR_ext1_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ReportConfigNR__reportType__ext1, reportSFTD),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_7 = {
	sizeof(struct ReportConfigNR__reportType__ext1),
	offsetof(struct ReportConfigNR__reportType__ext1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_reportType_2[] = {
	{ ATF_POINTER, 0, offsetof(struct ReportConfigNR__reportType, periodical),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 0, offsetof(struct ReportConfigNR__reportType, eventTriggered),
	...
	{ ATF_POINTER, 0, offsetof(struct ReportConfigNR__reportType, reportCGI),
	...
	{ ATF_POINTER, 1, offsetof(struct ReportConfigNR__reportType, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
...
asn_TYPE_descriptor_t asn_DEF_reportType_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_reportType_constr_2, CHOICE_constraint },
