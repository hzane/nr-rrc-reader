...
asn_TYPE_descriptor_t asn_DEF_failureType_7 = {
	...
	{ 0, &asn_PER_type_failureType_constr_7, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_scgFailureInfo_6[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CG_ConfigInfo_IEs__scgFailureInfo, measResultSCG),
		...
		0,
		{ 0, &asn_PER_memb_measResultSCG_constr_14,  memb_measResultSCG_constraint_6 },
		0, 0, /* No default value */
		"measResultSCG"
		},
};
...
asn_TYPE_member_t asn_MBR_CG_ConfigInfo_IEs_1[] = {
	{ ATF_POINTER, 13, offsetof(struct CG_ConfigInfo_IEs, ue_CapabilityInfo),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_ue_CapabilityInfo_constr_2,  memb_ue_CapabilityInfo_constraint_1 },
		0, 0, /* No default value */
		"ue-CapabilityInfo"
		},
	...
	{ ATF_POINTER, 11, offsetof(struct CG_ConfigInfo_IEs, candidateCellInfoListSN),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_candidateCellInfoListSN_constr_4,  memb_candidateCellInfoListSN_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 5, offsetof(struct CG_ConfigInfo_IEs, sourceConfigSCG),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_sourceConfigSCG_constr_18,  memb_sourceConfigSCG_constraint_1 },
		0, 0, /* No default value */
		"sourceConfigSCG"
		},
	{ ATF_POINTER, 4, offsetof(struct CG_ConfigInfo_IEs, scg_RB_Config),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_scg_RB_Config_constr_19,  memb_scg_RB_Config_constraint_1 },
		0, 0, /* No default value */
		"scg-RB-Config"
		},
	{ ATF_POINTER, 3, offsetof(struct CG_ConfigInfo_IEs, mcg_RB_Config),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_mcg_RB_Config_constr_20,  memb_mcg_RB_Config_constraint_1 },
		0, 0, /* No default value */
		"mcg-RB-Config"
		},
