...
static asn_per_constraints_t asn_PER_type_dualPA_Architecture_constr_21 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_intraBandENDC_Support_v1540_constr_23 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_ul_TimingAlignmentEUTRA_NR_constr_26 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_singleUL_Transmission_2 = {
	...
	{ 0, &asn_PER_type_singleUL_Transmission_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_dynamicPowerSharing_4 = {
	...
	{ 0, &asn_PER_type_dynamicPowerSharing_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_tdm_Pattern_6 = {
	...
	{ 0, &asn_PER_type_tdm_Pattern_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_ul_SharingEUTRA_NR_8 = {
	...
	{ 0, &asn_PER_type_ul_SharingEUTRA_NR_constr_8, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_ul_SwitchingTimeEUTRA_NR_12 = {
	...
	{ 0, &asn_PER_type_ul_SwitchingTimeEUTRA_NR_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_simultaneousRxTxInterBandENDC_15 = {
	...
	{ 0, &asn_PER_type_simultaneousRxTxInterBandENDC_constr_15, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_asyncIntraBandENDC_17 = {
	...
	{ 0, &asn_PER_type_asyncIntraBandENDC_constr_17, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_asyncIntraBandENDC_specs_17	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_dualPA_Architecture_value2enum_21[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_dualPA_Architecture_enum2value_21[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_dualPA_Architecture_specs_21 = {
	asn_MAP_dualPA_Architecture_value2enum_21,	/* "tag" => N; sorted by tag */
	asn_MAP_dualPA_Architecture_enum2value_21,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_dualPA_Architecture_tags_21[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_dualPA_Architecture_21 = {
	"dualPA-Architecture",
	"dualPA-Architecture",
	&asn_OP_NativeEnumerated,
	asn_DEF_dualPA_Architecture_tags_21,
	sizeof(asn_DEF_dualPA_Architecture_tags_21)
		/sizeof(asn_DEF_dualPA_Architecture_tags_21[0]) - 1, /* 1 */
	asn_DEF_dualPA_Architecture_tags_21,	/* Same as above */
	sizeof(asn_DEF_dualPA_Architecture_tags_21)
		/sizeof(asn_DEF_dualPA_Architecture_tags_21[0]), /* 2 */
	{ 0, &asn_PER_type_dualPA_Architecture_constr_21, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_dualPA_Architecture_specs_21	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_intraBandENDC_Support_v1540_value2enum_23[] = {
	{ 0,	14,	"non-contiguous" },
	{ 1,	4,	"both" }
};
static const unsigned int asn_MAP_intraBandENDC_Support_v1540_enum2value_23[] = {
	1,	/* both(1) */
	0	/* non-contiguous(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_intraBandENDC_Support_v1540_specs_23 = {
	asn_MAP_intraBandENDC_Support_v1540_value2enum_23,	/* "tag" => N; sorted by tag */
	asn_MAP_intraBandENDC_Support_v1540_enum2value_23,	/* N => "tag"; sorted by N */
	2,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_intraBandENDC_Support_v1540_tags_23[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_intraBandENDC_Support_v1540_23 = {
	"intraBandENDC-Support-v1540",
	"intraBandENDC-Support-v1540",
	&asn_OP_NativeEnumerated,
	asn_DEF_intraBandENDC_Support_v1540_tags_23,
	sizeof(asn_DEF_intraBandENDC_Support_v1540_tags_23)
		/sizeof(asn_DEF_intraBandENDC_Support_v1540_tags_23[0]) - 1, /* 1 */
	asn_DEF_intraBandENDC_Support_v1540_tags_23,	/* Same as above */
	sizeof(asn_DEF_intraBandENDC_Support_v1540_tags_23)
		/sizeof(asn_DEF_intraBandENDC_Support_v1540_tags_23[0]), /* 2 */
	{ 0, &asn_PER_type_intraBandENDC_Support_v1540_constr_23, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_intraBandENDC_Support_v1540_specs_23	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_ul_TimingAlignmentEUTRA_NR_value2enum_26[] = {
	{ 0,	8,	"required" }
};
static const unsigned int asn_MAP_ul_TimingAlignmentEUTRA_NR_enum2value_26[] = {
	0	/* required(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_ul_TimingAlignmentEUTRA_NR_specs_26 = {
	asn_MAP_ul_TimingAlignmentEUTRA_NR_value2enum_26,	/* "tag" => N; sorted by tag */
	asn_MAP_ul_TimingAlignmentEUTRA_NR_enum2value_26,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_ul_TimingAlignmentEUTRA_NR_tags_26[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ul_TimingAlignmentEUTRA_NR_26 = {
	"ul-TimingAlignmentEUTRA-NR",
	"ul-TimingAlignmentEUTRA-NR",
	&asn_OP_NativeEnumerated,
	asn_DEF_ul_TimingAlignmentEUTRA_NR_tags_26,
	sizeof(asn_DEF_ul_TimingAlignmentEUTRA_NR_tags_26)
		/sizeof(asn_DEF_ul_TimingAlignmentEUTRA_NR_tags_26[0]) - 1, /* 1 */
	asn_DEF_ul_TimingAlignmentEUTRA_NR_tags_26,	/* Same as above */
	sizeof(asn_DEF_ul_TimingAlignmentEUTRA_NR_tags_26)
		/sizeof(asn_DEF_ul_TimingAlignmentEUTRA_NR_tags_26[0]), /* 2 */
	{ 0, &asn_PER_type_ul_TimingAlignmentEUTRA_NR_constr_26, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_ul_TimingAlignmentEUTRA_NR_specs_26	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_20[] = {
	{ ATF_POINTER, 3, offsetof(struct MRDC_Parameters__ext1, dualPA_Architecture),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_dualPA_Architecture_21,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"dualPA-Architecture"
		},
	{ ATF_POINTER, 2, offsetof(struct MRDC_Parameters__ext1, intraBandENDC_Support_v1540),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_intraBandENDC_Support_v1540_23,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"intraBandENDC-Support-v1540"
		},
	{ ATF_POINTER, 1, offsetof(struct MRDC_Parameters__ext1, ul_TimingAlignmentEUTRA_NR),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ul_TimingAlignmentEUTRA_NR_26,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ul-TimingAlignmentEUTRA-NR"
...
static const int asn_MAP_ext1_oms_20[] = { 0, 1, 2 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_20 = {
	sizeof(struct MRDC_Parameters__ext1),
	offsetof(struct MRDC_Parameters__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_MRDC_Parameters_1[] = {
	{ ATF_POINTER, 8, offsetof(struct MRDC_Parameters, singleUL_Transmission),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 7, offsetof(struct MRDC_Parameters, dynamicPowerSharing),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct MRDC_Parameters, tdm_Pattern),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct MRDC_Parameters, ul_SharingEUTRA_NR),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct MRDC_Parameters, ul_SwitchingTimeEUTRA_NR),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct MRDC_Parameters, simultaneousRxTxInterBandENDC),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct MRDC_Parameters, asyncIntraBandENDC),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct MRDC_Parameters, ext1),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext1_20,
		0,
...
static const int asn_MAP_MRDC_Parameters_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7 };
