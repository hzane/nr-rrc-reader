...
static asn_TYPE_member_t asn_MBR_timeInfo_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SIB9__timeInfo, timeInfoUTC),
		...
		&asn_DEF_INTEGER,
		0,
		{ 0, &asn_PER_memb_timeInfoUTC_constr_3,  memb_timeInfoUTC_constraint_2 },
	...
	{ ATF_POINTER, 3, offsetof(struct SIB9__timeInfo, dayLightSavingTime),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_dayLightSavingTime_constr_4,  memb_dayLightSavingTime_constraint_2 },
		0, 0, /* No default value */
		"dayLightSavingTime"
		},
	{ ATF_POINTER, 2, offsetof(struct SIB9__timeInfo, leapSeconds),
		...
		0,
		{ 0, &asn_PER_memb_leapSeconds_constr_5,  memb_leapSeconds_constraint_2 },
		0, 0, /* No default value */
		"leapSeconds"
		},
	{ ATF_POINTER, 1, offsetof(struct SIB9__timeInfo, localTimeOffset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_localTimeOffset_constr_6,  memb_localTimeOffset_constraint_2 },
		0, 0, /* No default value */
		"localTimeOffset"
		},
};
