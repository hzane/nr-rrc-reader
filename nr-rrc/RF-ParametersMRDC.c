 ...
 */
static asn_oer_constraints_t asn_OER_type_srs_SwitchingTimeRequested_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_srs_SwitchingTimeRequested_constr_6 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_srs_SwitchingTimeRequested_value2enum_6[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_srs_SwitchingTimeRequested_enum2value_6[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_srs_SwitchingTimeRequested_specs_6 = {
	asn_MAP_srs_SwitchingTimeRequested_value2enum_6,	/* "tag" => N; sorted by tag */
	asn_MAP_srs_SwitchingTimeRequested_enum2value_6,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_srs_SwitchingTimeRequested_tags_6[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_srs_SwitchingTimeRequested_6 = {
	"srs-SwitchingTimeRequested",
	"srs-SwitchingTimeRequested",
	&asn_OP_NativeEnumerated,
	asn_DEF_srs_SwitchingTimeRequested_tags_6,
	sizeof(asn_DEF_srs_SwitchingTimeRequested_tags_6)
		/sizeof(asn_DEF_srs_SwitchingTimeRequested_tags_6[0]) - 1, /* 1 */
	asn_DEF_srs_SwitchingTimeRequested_tags_6,	/* Same as above */
	sizeof(asn_DEF_srs_SwitchingTimeRequested_tags_6)
		/sizeof(asn_DEF_srs_SwitchingTimeRequested_tags_6[0]), /* 2 */
	{ &asn_OER_type_srs_SwitchingTimeRequested_constr_6, &asn_PER_type_srs_SwitchingTimeRequested_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_srs_SwitchingTimeRequested_specs_6	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_5[] = {
	{ ATF_POINTER, 2, offsetof(struct RF_ParametersMRDC__ext1, srs_SwitchingTimeRequested),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_srs_SwitchingTimeRequested_6,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"srs-SwitchingTimeRequested"
		},
	{ ATF_POINTER, 1, offsetof(struct RF_ParametersMRDC__ext1, supportedBandCombinationList_v1540),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_5 = {
	sizeof(struct RF_ParametersMRDC__ext1),
	offsetof(struct RF_ParametersMRDC__ext1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext2_9[] = {
	{ ATF_POINTER, 1, offsetof(struct RF_ParametersMRDC__ext2, supportedBandCombinationList_v1550),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_9 = {
	sizeof(struct RF_ParametersMRDC__ext2),
	offsetof(struct RF_ParametersMRDC__ext2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext3_11[] = {
	{ ATF_POINTER, 2, offsetof(struct RF_ParametersMRDC__ext3, supportedBandCombinationList_v1560),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct RF_ParametersMRDC__ext3, supportedBandCombinationListNEDC_Only),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_11 = {
	sizeof(struct RF_ParametersMRDC__ext3),
	offsetof(struct RF_ParametersMRDC__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_RF_ParametersMRDC_1[] = {
	{ ATF_POINTER, 5, offsetof(struct RF_ParametersMRDC, supportedBandCombinationList),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BandCombinationList,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct RF_ParametersMRDC, appliedFreqBandListFilter),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct RF_ParametersMRDC, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct RF_ParametersMRDC, ext2),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext2_9,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RF_ParametersMRDC, ext3),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext3_11,
		0,
...
static const int asn_MAP_RF_ParametersMRDC_oms_1[] = { 0, 1, 2, 3, 4 };
