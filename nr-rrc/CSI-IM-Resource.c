...
asn_TYPE_descriptor_t asn_DEF_subcarrierLocation_p0_5 = {
	...
	{ 0, &asn_PER_type_subcarrierLocation_p0_constr_5, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_pattern0_4[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_IM_Resource__csi_IM_ResourceElementPattern__pattern0, symbolLocation_p0),
		...
		0,
		{ 0, &asn_PER_memb_symbolLocation_p0_constr_12,  memb_symbolLocation_p0_constraint_4 },
		0, 0, /* No default value */
		"symbolLocation-p0"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_subcarrierLocation_p1_14 = {
	...
	{ 0, &asn_PER_type_subcarrierLocation_p1_constr_14, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_pattern1_13[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_IM_Resource__csi_IM_ResourceElementPattern__pattern1, symbolLocation_p1),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_symbolLocation_p1_constr_18,  memb_symbolLocation_p1_constraint_13 },
		0, 0, /* No default value */
		"symbolLocation-p1"
		},
};
...
static asn_TYPE_member_t asn_MBR_csi_IM_ResourceElementPattern_3[] = {
	{ ATF_POINTER, 0, offsetof(struct CSI_IM_Resource__csi_IM_ResourceElementPattern, pattern0),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_pattern0_4,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct CSI_IM_Resource__csi_IM_ResourceElementPattern, pattern1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_pattern1_13,
		0,
...
asn_TYPE_descriptor_t asn_DEF_csi_IM_ResourceElementPattern_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_csi_IM_ResourceElementPattern_constr_3, CHOICE_constraint },
