...
static asn_TYPE_member_t asn_MBR_ext1_4[] = {
	{ ATF_POINTER, 3, offsetof(struct AS_Config__ext1, sourceRB_SN_Config),
		...
		0,
		{ 0, &asn_PER_memb_sourceRB_SN_Config_constr_5,  memb_sourceRB_SN_Config_constraint_4 },
	...
	{ ATF_POINTER, 2, offsetof(struct AS_Config__ext1, sourceSCG_NR_Config),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_sourceSCG_NR_Config_constr_6,  memb_sourceSCG_NR_Config_constraint_4 },
		0, 0, /* No default value */
		"sourceSCG-NR-Config"
		},
