...
asn_TYPE_descriptor_t asn_DEF_groupHoppingEnabledTransformPrecoding_2 = {
	...
	{ 0, &asn_PER_type_groupHoppingEnabledTransformPrecoding_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_PUSCH_ConfigCommon_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct PUSCH_ConfigCommon, msg3_DeltaPreamble),
		...
		0,
		{ 0, &asn_PER_memb_msg3_DeltaPreamble_constr_5,  memb_msg3_DeltaPreamble_constraint_1 },
		0, 0, /* No default value */
		"msg3-DeltaPreamble"
		},
	{ ATF_POINTER, 1, offsetof(struct PUSCH_ConfigCommon, p0_NominalWithGrant),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_p0_NominalWithGrant_constr_6,  memb_p0_NominalWithGrant_constraint_1 },
		0, 0, /* No default value */
		"p0-NominalWithGrant"
		},
};
