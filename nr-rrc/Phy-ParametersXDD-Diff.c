...
static asn_oer_constraints_t asn_OER_type_dl_SchedulingOffset_PDSCH_TypeA_constr_12 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_dl_SchedulingOffset_PDSCH_TypeA_constr_12 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_dl_SchedulingOffset_PDSCH_TypeB_constr_14 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_dl_SchedulingOffset_PDSCH_TypeB_constr_14 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_ul_SchedulingOffset_constr_16 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_ul_SchedulingOffset_constr_16 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_dl_SchedulingOffset_PDSCH_TypeA_value2enum_12[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_dl_SchedulingOffset_PDSCH_TypeA_enum2value_12[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_dl_SchedulingOffset_PDSCH_TypeA_specs_12 = {
	asn_MAP_dl_SchedulingOffset_PDSCH_TypeA_value2enum_12,	/* "tag" => N; sorted by tag */
	asn_MAP_dl_SchedulingOffset_PDSCH_TypeA_enum2value_12,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_dl_SchedulingOffset_PDSCH_TypeA_tags_12[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_dl_SchedulingOffset_PDSCH_TypeA_12 = {
	"dl-SchedulingOffset-PDSCH-TypeA",
	"dl-SchedulingOffset-PDSCH-TypeA",
	&asn_OP_NativeEnumerated,
	asn_DEF_dl_SchedulingOffset_PDSCH_TypeA_tags_12,
	sizeof(asn_DEF_dl_SchedulingOffset_PDSCH_TypeA_tags_12)
		/sizeof(asn_DEF_dl_SchedulingOffset_PDSCH_TypeA_tags_12[0]) - 1, /* 1 */
	asn_DEF_dl_SchedulingOffset_PDSCH_TypeA_tags_12,	/* Same as above */
	sizeof(asn_DEF_dl_SchedulingOffset_PDSCH_TypeA_tags_12)
		/sizeof(asn_DEF_dl_SchedulingOffset_PDSCH_TypeA_tags_12[0]), /* 2 */
	{ &asn_OER_type_dl_SchedulingOffset_PDSCH_TypeA_constr_12, &asn_PER_type_dl_SchedulingOffset_PDSCH_TypeA_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_dl_SchedulingOffset_PDSCH_TypeA_specs_12	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_dl_SchedulingOffset_PDSCH_TypeB_value2enum_14[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_dl_SchedulingOffset_PDSCH_TypeB_enum2value_14[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_dl_SchedulingOffset_PDSCH_TypeB_specs_14 = {
	asn_MAP_dl_SchedulingOffset_PDSCH_TypeB_value2enum_14,	/* "tag" => N; sorted by tag */
	asn_MAP_dl_SchedulingOffset_PDSCH_TypeB_enum2value_14,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_dl_SchedulingOffset_PDSCH_TypeB_tags_14[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_dl_SchedulingOffset_PDSCH_TypeB_14 = {
	"dl-SchedulingOffset-PDSCH-TypeB",
	"dl-SchedulingOffset-PDSCH-TypeB",
	&asn_OP_NativeEnumerated,
	asn_DEF_dl_SchedulingOffset_PDSCH_TypeB_tags_14,
	sizeof(asn_DEF_dl_SchedulingOffset_PDSCH_TypeB_tags_14)
		/sizeof(asn_DEF_dl_SchedulingOffset_PDSCH_TypeB_tags_14[0]) - 1, /* 1 */
	asn_DEF_dl_SchedulingOffset_PDSCH_TypeB_tags_14,	/* Same as above */
	sizeof(asn_DEF_dl_SchedulingOffset_PDSCH_TypeB_tags_14)
		/sizeof(asn_DEF_dl_SchedulingOffset_PDSCH_TypeB_tags_14[0]), /* 2 */
	{ &asn_OER_type_dl_SchedulingOffset_PDSCH_TypeB_constr_14, &asn_PER_type_dl_SchedulingOffset_PDSCH_TypeB_constr_14, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_dl_SchedulingOffset_PDSCH_TypeB_specs_14	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_ul_SchedulingOffset_value2enum_16[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_ul_SchedulingOffset_enum2value_16[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_ul_SchedulingOffset_specs_16 = {
	asn_MAP_ul_SchedulingOffset_value2enum_16,	/* "tag" => N; sorted by tag */
	asn_MAP_ul_SchedulingOffset_enum2value_16,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_ul_SchedulingOffset_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ul_SchedulingOffset_16 = {
	"ul-SchedulingOffset",
	"ul-SchedulingOffset",
	&asn_OP_NativeEnumerated,
	asn_DEF_ul_SchedulingOffset_tags_16,
	sizeof(asn_DEF_ul_SchedulingOffset_tags_16)
		/sizeof(asn_DEF_ul_SchedulingOffset_tags_16[0]) - 1, /* 1 */
	asn_DEF_ul_SchedulingOffset_tags_16,	/* Same as above */
	sizeof(asn_DEF_ul_SchedulingOffset_tags_16)
		/sizeof(asn_DEF_ul_SchedulingOffset_tags_16[0]), /* 2 */
	{ &asn_OER_type_ul_SchedulingOffset_constr_16, &asn_PER_type_ul_SchedulingOffset_constr_16, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_ul_SchedulingOffset_specs_16	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_11[] = {
	{ ATF_POINTER, 3, offsetof(struct Phy_ParametersXDD_Diff__ext1, dl_SchedulingOffset_PDSCH_TypeA),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_dl_SchedulingOffset_PDSCH_TypeA_12,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"dl-SchedulingOffset-PDSCH-TypeA"
		},
	{ ATF_POINTER, 2, offsetof(struct Phy_ParametersXDD_Diff__ext1, dl_SchedulingOffset_PDSCH_TypeB),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_dl_SchedulingOffset_PDSCH_TypeB_14,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"dl-SchedulingOffset-PDSCH-TypeB"
		},
	{ ATF_POINTER, 1, offsetof(struct Phy_ParametersXDD_Diff__ext1, ul_SchedulingOffset),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ul_SchedulingOffset_16,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ul-SchedulingOffset"
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_11 = {
	sizeof(struct Phy_ParametersXDD_Diff__ext1),
	offsetof(struct Phy_ParametersXDD_Diff__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_Phy_ParametersXDD_Diff_1[] = {
	{ ATF_POINTER, 5, offsetof(struct Phy_ParametersXDD_Diff, dynamicSFI),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct Phy_ParametersXDD_Diff, twoPUCCH_F0_2_ConsecSymbols),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct Phy_ParametersXDD_Diff, twoDifferentTPC_Loop_PUSCH),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct Phy_ParametersXDD_Diff, twoDifferentTPC_Loop_PUCCH),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct Phy_ParametersXDD_Diff, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_11,
		0,
...
static const int asn_MAP_Phy_ParametersXDD_Diff_oms_1[] = { 0, 1, 2, 3, 4 };
