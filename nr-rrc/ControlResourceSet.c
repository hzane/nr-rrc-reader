...
asn_TYPE_descriptor_t asn_DEF_reg_BundleSize_7 = {
	...
	{ 0, &asn_PER_type_reg_BundleSize_constr_7, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_interleaverSize_11 = {
	...
	{ 0, &asn_PER_type_interleaverSize_constr_11, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_interleaved_6[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ControlResourceSet__cce_REG_MappingType__interleaved, shiftIndex),
		...
		0,
		{ 0, &asn_PER_memb_shiftIndex_constr_15,  memb_shiftIndex_constraint_6 },
		0, 0, /* No default value */
		"shiftIndex"
		},
};
...
static asn_TYPE_member_t asn_MBR_cce_REG_MappingType_5[] = {
	{ ATF_POINTER, 0, offsetof(struct ControlResourceSet__cce_REG_MappingType, interleaved),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ControlResourceSet__cce_REG_MappingType, nonInterleaved),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
...
asn_TYPE_descriptor_t asn_DEF_cce_REG_MappingType_5 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_cce_REG_MappingType_constr_5, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_precoderGranularity_17 = {
	...
	{ 0, &asn_PER_type_precoderGranularity_constr_17, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_tci_StatesPDCCH_ToAddList_20 = {
	...
	{ 0, &asn_PER_type_tci_StatesPDCCH_ToAddList_constr_20, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_tci_StatesPDCCH_ToReleaseList_22 = {
	...
	{ 0, &asn_PER_type_tci_StatesPDCCH_ToReleaseList_constr_22, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_tci_PresentInDCI_24 = {
	...
	{ 0, &asn_PER_type_tci_PresentInDCI_constr_24, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_ControlResourceSet_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ControlResourceSet, frequencyDomainResources),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_frequencyDomainResources_constr_3,  memb_frequencyDomainResources_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ControlResourceSet, duration),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_duration_constr_4,  memb_duration_constraint_1 },
		0, 0, /* No default value */
		"duration"
		},
	...
	{ ATF_POINTER, 4, offsetof(struct ControlResourceSet, tci_StatesPDCCH_ToAddList),
		...
		0,
		{ 0, &asn_PER_memb_tci_StatesPDCCH_ToAddList_constr_20,  memb_tci_StatesPDCCH_ToAddList_constraint_1 },
		0, 0, /* No default value */
		"tci-StatesPDCCH-ToAddList"
		},
	{ ATF_POINTER, 3, offsetof(struct ControlResourceSet, tci_StatesPDCCH_ToReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_tci_StatesPDCCH_ToReleaseList_constr_22,  memb_tci_StatesPDCCH_ToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"tci-StatesPDCCH-ToReleaseList"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct ControlResourceSet, pdcch_DMRS_ScramblingID),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_pdcch_DMRS_ScramblingID_constr_26,  memb_pdcch_DMRS_ScramblingID_constraint_1 },
		0, 0, /* No default value */
