...
asn_TYPE_descriptor_t asn_DEF_qcl_info_6 = {
	...
	{ 0, &asn_PER_type_qcl_info_constr_6, SEQUENCE_OF_constraint },
	asn_MBR_qcl_info_6,
	1,	/* Single element */
...
static asn_TYPE_member_t asn_MBR_nzp_CSI_RS_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_AssociatedReportConfigInfo__resourcesForChannel__nzp_CSI_RS, resourceSet),
		...
		0,
		{ 0, &asn_PER_memb_resourceSet_constr_5,  memb_resourceSet_constraint_4 },
		0, 0, /* No default value */
		"resourceSet"
		},
	{ ATF_POINTER, 1, offsetof(struct CSI_AssociatedReportConfigInfo__resourcesForChannel__nzp_CSI_RS, qcl_info),
		...
		&asn_DEF_qcl_info_6,
		0,
		{ 0, &asn_PER_memb_qcl_info_constr_6,  memb_qcl_info_constraint_4 },
		0, 0, /* No default value */
		"qcl-info"
		},
};
...
static asn_TYPE_member_t asn_MBR_resourcesForChannel_3[] = {
	{ ATF_POINTER, 0, offsetof(struct CSI_AssociatedReportConfigInfo__resourcesForChannel, nzp_CSI_RS),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_AssociatedReportConfigInfo__resourcesForChannel, csi_SSB_ResourceSet),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_csi_SSB_ResourceSet_constr_8,  memb_csi_SSB_ResourceSet_constraint_3 },
		0, 0, /* No default value */
		"csi-SSB-ResourceSet"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_resourcesForChannel_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_resourcesForChannel_constr_3, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_CSI_AssociatedReportConfigInfo_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct CSI_AssociatedReportConfigInfo, csi_IM_ResourcesForInterference),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_csi_IM_ResourcesForInterference_constr_9,  memb_csi_IM_ResourcesForInterference_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct CSI_AssociatedReportConfigInfo, nzp_CSI_RS_ResourcesForInterference),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_nzp_CSI_RS_ResourcesForInterference_constr_10,  memb_nzp_CSI_RS_ResourcesForInterference_constraint_1 },
		0, 0, /* No default value */
