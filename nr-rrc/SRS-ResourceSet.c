...
asn_TYPE_descriptor_t asn_DEF_srs_ResourceIdList_3 = {
	...
	{ 0, &asn_PER_type_srs_ResourceIdList_constr_3, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_aperiodicSRS_ResourceTriggerList_v1530_12[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		{ 0, &asn_PER_memb_Member_constr_13,  memb_NativeInteger_constraint_12 },
		0, 0, /* No default value */
		""
		},
};
...
asn_TYPE_descriptor_t asn_DEF_aperiodicSRS_ResourceTriggerList_v1530_12 = {
	...
	{ 0, &asn_PER_type_aperiodicSRS_ResourceTriggerList_v1530_constr_12, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_ext1_11[] = {
	{ ATF_POINTER, 1, offsetof(struct SRS_ResourceSet__resourceType__aperiodic__ext1, aperiodicSRS_ResourceTriggerList_v1530),
		...
		0,
		{ 0, &asn_PER_memb_aperiodicSRS_ResourceTriggerList_v1530_constr_12,  memb_aperiodicSRS_ResourceTriggerList_v1530_constraint_11 },
		0, 0, /* No default value */
		"aperiodicSRS-ResourceTriggerList-v1530"
		},
};
...
static asn_TYPE_member_t asn_MBR_aperiodic_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_ResourceSet__resourceType__aperiodic, aperiodicSRS_ResourceTrigger),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_aperiodicSRS_ResourceTrigger_constr_7,  memb_aperiodicSRS_ResourceTrigger_constraint_6 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct SRS_ResourceSet__resourceType__aperiodic, slotOffset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_slotOffset_constr_9,  memb_slotOffset_constraint_6 },
		0, 0, /* No default value */
		"slotOffset"
		},
...
static asn_TYPE_member_t asn_MBR_resourceType_5[] = {
	{ ATF_POINTER, 0, offsetof(struct SRS_ResourceSet__resourceType, aperiodic),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_aperiodic_6,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SRS_ResourceSet__resourceType, semi_persistent),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SRS_ResourceSet__resourceType, periodic),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_periodic_17,
		0,
...
asn_TYPE_descriptor_t asn_DEF_resourceType_5 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_resourceType_constr_5, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_usage_20 = {
	...
	{ 0, &asn_PER_type_usage_constr_20, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_usage_specs_20	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_pathlossReferenceRS_27[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_ResourceSet__pathlossReferenceRS, ssb_Index),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SSB_Index,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_ResourceSet__pathlossReferenceRS, csi_RS_Index),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NZP_CSI_RS_ResourceId,
		0,
...
asn_TYPE_descriptor_t asn_DEF_pathlossReferenceRS_27 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_pathlossReferenceRS_constr_27, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_srs_PowerControlAdjustmentStates_30 = {
	...
	{ 0, &asn_PER_type_srs_PowerControlAdjustmentStates_constr_30, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_SRS_ResourceSet_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SRS_ResourceSet, srs_ResourceIdList),
		...
		0,
		{ 0, &asn_PER_memb_srs_ResourceIdList_constr_3,  memb_srs_ResourceIdList_constraint_1 },
		0, 0, /* No default value */
		"srs-ResourceIdList"
		},
	...
	{ ATF_POINTER, 3, offsetof(struct SRS_ResourceSet, p0),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_p0_constr_26,  memb_p0_constraint_1 },
		0, 0, /* No default value */
		"p0"
		},
