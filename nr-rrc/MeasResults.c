...
static asn_TYPE_member_t asn_MBR_measResultNeighCells_4[] = {
	{ ATF_POINTER, 0, offsetof(struct MeasResults__measResultNeighCells, measResultListNR),
	...
	{ ATF_POINTER, 0, offsetof(struct MeasResults__measResultNeighCells, measResultListEUTRA),
