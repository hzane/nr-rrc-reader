...
asn_TYPE_descriptor_t asn_DEF_candidateBeamRSList_5 = {
	...
	{ 0, &asn_PER_type_candidateBeamRSList_constr_5, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_ssb_perRACH_Occasion_7 = {
	...
	{ 0, &asn_PER_type_ssb_perRACH_Occasion_constr_7, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_beamFailureRecoveryTimer_19 = {
	...
	{ 0, &asn_PER_type_beamFailureRecoveryTimer_constr_19, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_BeamFailureRecoveryConfig_1[] = {
	{ ATF_POINTER, 10, offsetof(struct BeamFailureRecoveryConfig, rootSequenceIndex_BFR),
		...
		0,
		{ 0, &asn_PER_memb_rootSequenceIndex_BFR_constr_2,  memb_rootSequenceIndex_BFR_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 7, offsetof(struct BeamFailureRecoveryConfig, candidateBeamRSList),
		...
		0,
		{ 0, &asn_PER_memb_candidateBeamRSList_constr_5,  memb_candidateBeamRSList_constraint_1 },
		0, 0, /* No default value */
		"candidateBeamRSList"
		},
	...
	{ ATF_POINTER, 5, offsetof(struct BeamFailureRecoveryConfig, ra_ssb_OccasionMaskIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ra_ssb_OccasionMaskIndex_constr_16,  memb_ra_ssb_OccasionMaskIndex_constraint_1 },
		0, 0, /* No default value */
