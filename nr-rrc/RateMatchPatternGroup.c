...
static asn_TYPE_member_t asn_MBR_Member_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPatternGroup__Member, cellLevel),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RateMatchPatternGroup__Member, bwpLevel),
...
asn_TYPE_descriptor_t asn_DEF_RateMatchPatternGroup = {
	...
	sizeof(asn_DEF_RateMatchPatternGroup_tags_1)
		/sizeof(asn_DEF_RateMatchPatternGroup_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_RateMatchPatternGroup_constr_1, SEQUENCE_OF_constraint },
