...
typedef enum EUTRA_ParametersCommon__ext1__ne_DC {
	EUTRA_ParametersCommon__ext1__ne_DC_supported	= 0
} e_EUTRA_ParametersCommon__ext1__ne_DC;
...
typedef struct EUTRA_ParametersCommon {
	 ...
	 */
	struct EUTRA_ParametersCommon__ext1 {
		long	*ne_DC;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_ne_DC_11;	// (Use -fall-defs-global to expose) */
