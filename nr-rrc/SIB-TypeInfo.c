...
asn_TYPE_descriptor_t asn_DEF_type_2 = {
	...
	{ 0, &asn_PER_type_type_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_areaScope_21 = {
	...
	{ 0, &asn_PER_type_areaScope_constr_21, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_SIB_TypeInfo_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct SIB_TypeInfo, valueTag),
		...
		0,
		{ 0, &asn_PER_memb_valueTag_constr_20,  memb_valueTag_constraint_1 },
		0, 0, /* No default value */
		"valueTag"
		},
