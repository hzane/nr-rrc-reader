...
asn_TYPE_descriptor_t asn_DEF_supportedCodebookMode_8 = {
	...
	{ 0, &asn_PER_type_supportedCodebookMode_constr_8, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_supportedNumberPanels_12 = {
	...
	{ 0, &asn_PER_type_supportedNumberPanels_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_DummyC_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyC, maxNumberResources),
		...
		0,
		{ 0, &asn_PER_memb_maxNumberResources_constr_6,  memb_maxNumberResources_constraint_1 },
		0, 0, /* No default value */
		"maxNumberResources"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct DummyC, totalNumberTxPorts),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_totalNumberTxPorts_constr_7,  memb_totalNumberTxPorts_constraint_1 },
		0, 0, /* No default value */
		"totalNumberTxPorts"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyC, maxNumberCSI_RS_PerResourceSet),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberCSI_RS_PerResourceSet_constr_15,  memb_maxNumberCSI_RS_PerResourceSet_constraint_1 },
		0, 0, /* No default value */
