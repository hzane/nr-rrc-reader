...
static asn_TYPE_member_t asn_MBR_criticalExtensions_3[] = {
	{ ATF_POINTER, 0, offsetof(struct CounterCheckResponse__criticalExtensions, counterCheckResponse),
	...
	{ ATF_POINTER, 0, offsetof(struct CounterCheckResponse__criticalExtensions, criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
