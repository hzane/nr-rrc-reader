...
static asn_oer_constraints_t asn_OER_type_srs_SwitchingTimeRequested_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_srs_SwitchingTimeRequested_9 = {
	...
	{ &asn_OER_type_srs_SwitchingTimeRequested_constr_9, &asn_PER_type_srs_SwitchingTimeRequested_constr_9, NativeEnumerated_constraint },
