...
static asn_per_constraints_t asn_PER_type_srs_SwitchingTimeRequested_constr_9 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_supportedBandListNR_2 = {
	...
	{ 0, &asn_PER_type_supportedBandListNR_constr_2, SEQUENCE_OF_constraint },
	asn_MBR_supportedBandListNR_2,
	1,	/* Single element */
	&asn_SPC_supportedBandListNR_specs_2	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_srs_SwitchingTimeRequested_value2enum_9[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_srs_SwitchingTimeRequested_enum2value_9[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_srs_SwitchingTimeRequested_specs_9 = {
	asn_MAP_srs_SwitchingTimeRequested_value2enum_9,	/* "tag" => N; sorted by tag */
	asn_MAP_srs_SwitchingTimeRequested_enum2value_9,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_srs_SwitchingTimeRequested_tags_9[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_srs_SwitchingTimeRequested_9 = {
	"srs-SwitchingTimeRequested",
	"srs-SwitchingTimeRequested",
	&asn_OP_NativeEnumerated,
	asn_DEF_srs_SwitchingTimeRequested_tags_9,
	sizeof(asn_DEF_srs_SwitchingTimeRequested_tags_9)
		/sizeof(asn_DEF_srs_SwitchingTimeRequested_tags_9[0]) - 1, /* 1 */
	asn_DEF_srs_SwitchingTimeRequested_tags_9,	/* Same as above */
	sizeof(asn_DEF_srs_SwitchingTimeRequested_tags_9)
		/sizeof(asn_DEF_srs_SwitchingTimeRequested_tags_9[0]), /* 2 */
	{ 0, &asn_PER_type_srs_SwitchingTimeRequested_constr_9, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_srs_SwitchingTimeRequested_specs_9	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_7[] = {
	{ ATF_POINTER, 2, offsetof(struct RF_Parameters__ext1, supportedBandCombinationList_v1540),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct RF_Parameters__ext1, srs_SwitchingTimeRequested),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_srs_SwitchingTimeRequested_9,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"srs-SwitchingTimeRequested"
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_7 = {
	sizeof(struct RF_Parameters__ext1),
	offsetof(struct RF_Parameters__ext1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext2_11[] = {
	{ ATF_POINTER, 1, offsetof(struct RF_Parameters__ext2, supportedBandCombinationList_v1550),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_11 = {
	sizeof(struct RF_Parameters__ext2),
	offsetof(struct RF_Parameters__ext2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext3_13[] = {
	{ ATF_POINTER, 1, offsetof(struct RF_Parameters__ext3, supportedBandCombinationList_v1560),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_13 = {
	sizeof(struct RF_Parameters__ext3),
	offsetof(struct RF_Parameters__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_RF_Parameters_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RF_Parameters, supportedBandListNR),
		...
		0,
		{ 0, &asn_PER_memb_supportedBandListNR_constr_2,  memb_supportedBandListNR_constraint_1 },
		0, 0, /* No default value */
		"supportedBandListNR"
		},
	{ ATF_POINTER, 5, offsetof(struct RF_Parameters, supportedBandCombinationList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct RF_Parameters, appliedFreqBandListFilter),
	...
	{ ATF_POINTER, 3, offsetof(struct RF_Parameters, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct RF_Parameters, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext2_11,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RF_Parameters, ext3),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext3_13,
		0,
...
static const int asn_MAP_RF_Parameters_oms_1[] = { 1, 2, 3, 4, 5 };
