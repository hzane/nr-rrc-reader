...
asn_TYPE_descriptor_t asn_DEF_blackCellsToAddModList_17 = {
	...
	{ 0, &asn_PER_type_blackCellsToAddModList_constr_17, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_whiteCellsToAddModList_20 = {
	...
	{ 0, &asn_PER_type_whiteCellsToAddModList_constr_20, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_measCycleSCell_v1530_25 = {
	...
	{ 0, &asn_PER_type_measCycleSCell_v1530_constr_25, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_MeasObjectNR_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct MeasObjectNR, nrofSS_BlocksToAverage),
		...
		0,
		{ 0, &asn_PER_memb_nrofSS_BlocksToAverage_constr_10,  memb_nrofSS_BlocksToAverage_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct MeasObjectNR, nrofCSI_RS_ResourcesToAverage),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_nrofCSI_RS_ResourcesToAverage_constr_11,  memb_nrofCSI_RS_ResourcesToAverage_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasObjectNR, quantityConfigIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_quantityConfigIndex_constr_12,  memb_quantityConfigIndex_constraint_1 },
		0, 0, /* No default value */
		"quantityConfigIndex"
		},
	...
	{ ATF_POINTER, 4, offsetof(struct MeasObjectNR, blackCellsToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_blackCellsToAddModList_constr_17,  memb_blackCellsToAddModList_constraint_1 },
		0, 0, /* No default value */
		"blackCellsToAddModList"
		},
	...
	{ ATF_POINTER, 2, offsetof(struct MeasObjectNR, whiteCellsToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_whiteCellsToAddModList_constr_20,  memb_whiteCellsToAddModList_constraint_1 },
		0, 0, /* No default value */
		"whiteCellsToAddModList"
		},
