...
static asn_TYPE_member_t asn_MBR_explicit_6[] = {
	{ ATF_POINTER, 2, offsetof(struct TDD_UL_DL_SlotConfig__symbols__explicit, nrofDownlinkSymbols),
		...
		0,
		{ 0, &asn_PER_memb_nrofDownlinkSymbols_constr_7,  memb_nrofDownlinkSymbols_constraint_6 },
	...
	{ ATF_POINTER, 1, offsetof(struct TDD_UL_DL_SlotConfig__symbols__explicit, nrofUplinkSymbols),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_nrofUplinkSymbols_constr_8,  memb_nrofUplinkSymbols_constraint_6 },
		0, 0, /* No default value */
		"nrofUplinkSymbols"
		},
};
...
static asn_TYPE_member_t asn_MBR_symbols_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TDD_UL_DL_SlotConfig__symbols, allDownlink),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TDD_UL_DL_SlotConfig__symbols, allUplink),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct TDD_UL_DL_SlotConfig__symbols, Explicit),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_explicit_6,
		0,
...
asn_TYPE_descriptor_t asn_DEF_symbols_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_symbols_constr_3, CHOICE_constraint },
	asn_MBR_symbols_3,
	3,	/* Elements count */
