...
asn_TYPE_descriptor_t asn_DEF_purpose_3 = {
	...
	{ 0, &asn_PER_type_purpose_constr_3, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_purpose_specs_3	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_detectionResource_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RadioLinkMonitoringRS__detectionResource, ssb_Index),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RadioLinkMonitoringRS__detectionResource, csi_RS_Index),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
asn_TYPE_descriptor_t asn_DEF_detectionResource_7 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_detectionResource_constr_7, CHOICE_constraint },
