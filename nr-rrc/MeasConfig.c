...
static asn_TYPE_member_t asn_MBR_s_MeasureConfig_8[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MeasConfig__s_MeasureConfig, ssb_RSRP),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasConfig__s_MeasureConfig, csi_RSRP),
...
asn_TYPE_descriptor_t asn_DEF_s_MeasureConfig_8 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_s_MeasureConfig_constr_8, CHOICE_constraint },
