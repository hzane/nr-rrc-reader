...
asn_TYPE_member_t asn_MBR_DummyF_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DummyF, maxNumberPeriodicCSI_ReportPerBWP),
		...
		0,
		{ 0, &asn_PER_memb_maxNumberPeriodicCSI_ReportPerBWP_constr_2,  memb_maxNumberPeriodicCSI_ReportPerBWP_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyF, maxNumberAperiodicCSI_ReportPerBWP),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberAperiodicCSI_ReportPerBWP_constr_3,  memb_maxNumberAperiodicCSI_ReportPerBWP_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyF, maxNumberSemiPersistentCSI_ReportPerBWP),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberSemiPersistentCSI_ReportPerBWP_constr_4,  memb_maxNumberSemiPersistentCSI_ReportPerBWP_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyF, simultaneousCSI_ReportsAllCC),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_simultaneousCSI_ReportsAllCC_constr_5,  memb_simultaneousCSI_ReportsAllCC_constraint_1 },
		0, 0, /* No default value */
