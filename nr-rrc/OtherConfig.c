...
asn_TYPE_descriptor_t asn_DEF_delayBudgetReportingProhibitTimer_5 = {
	...
	{ 0, &asn_PER_type_delayBudgetReportingProhibitTimer_constr_5, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_delayBudgetReportingConfig_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct OtherConfig__delayBudgetReportingConfig, release),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct OtherConfig__delayBudgetReportingConfig, setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_4,
		0,
...
asn_TYPE_descriptor_t asn_DEF_delayBudgetReportingConfig_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_delayBudgetReportingConfig_constr_2, CHOICE_constraint },
