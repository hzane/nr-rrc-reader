...
asn_TYPE_descriptor_t asn_DEF_t304_4 = {
	...
	{ 0, &asn_PER_type_t304_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_t304_specs_4	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_rach_ConfigDedicated_13[] = {
	{ ATF_POINTER, 0, offsetof(struct ReconfigurationWithSync__rach_ConfigDedicated, uplink),
	...
	{ ATF_POINTER, 0, offsetof(struct ReconfigurationWithSync__rach_ConfigDedicated, supplementaryUplink),
...
asn_TYPE_descriptor_t asn_DEF_rach_ConfigDedicated_13 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_rach_ConfigDedicated_constr_13, CHOICE_constraint },
