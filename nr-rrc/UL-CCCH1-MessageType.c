...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH1_MessageType__c1, rrcResumeRequest1),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_CCCH1_MessageType__c1, spare3),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_CCCH1_MessageType__c1, spare2),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_CCCH1_MessageType__c1, spare1),
...
asn_TYPE_member_t asn_MBR_UL_CCCH1_MessageType_1[] = {
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH1_MessageType, c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH1_MessageType, messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
asn_TYPE_descriptor_t asn_DEF_UL_CCCH1_MessageType = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_UL_CCCH1_MessageType_constr_1, CHOICE_constraint },
