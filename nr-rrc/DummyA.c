...
asn_TYPE_descriptor_t asn_DEF_maxNumberPortsAcrossNZP_CSI_RS_PerCC_3 = {
	...
	{ 0, &asn_PER_type_maxNumberPortsAcrossNZP_CSI_RS_PerCC_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_maxNumberCS_IM_PerCC_39 = {
	...
	{ 0, &asn_PER_type_maxNumberCS_IM_PerCC_constr_39, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_maxNumberSimultaneousCSI_RS_ActBWP_AllCC_46 = {
	...
	{ 0, &asn_PER_type_maxNumberSimultaneousCSI_RS_ActBWP_AllCC_constr_46, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_totalNumberPortsSimultaneousCSI_RS_ActBWP_AllCC_80 = {
	...
	{ 0, &asn_PER_type_totalNumberPortsSimultaneousCSI_RS_ActBWP_AllCC_constr_80, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_DummyA_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DummyA, maxNumberNZP_CSI_RS_PerCC),
		...
		0,
		{ 0, &asn_PER_memb_maxNumberNZP_CSI_RS_PerCC_constr_2,  memb_maxNumberNZP_CSI_RS_PerCC_constraint_1 },
