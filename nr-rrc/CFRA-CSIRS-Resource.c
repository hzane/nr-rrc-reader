...
asn_TYPE_descriptor_t asn_DEF_ra_OccasionList_3 = {
	...
	{ 0, &asn_PER_type_ra_OccasionList_constr_3, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_CFRA_CSIRS_Resource_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CFRA_CSIRS_Resource, ra_OccasionList),
		...
		0,
		{ 0, &asn_PER_memb_ra_OccasionList_constr_3,  memb_ra_OccasionList_constraint_1 },
		0, 0, /* No default value */
		"ra-OccasionList"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CFRA_CSIRS_Resource, ra_PreambleIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ra_PreambleIndex_constr_5,  memb_ra_PreambleIndex_constraint_1 },
		0, 0, /* No default value */
		"ra-PreambleIndex"
		},
};
