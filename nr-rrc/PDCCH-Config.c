...
asn_TYPE_descriptor_t asn_DEF_controlResourceSetToAddModList_2 = {
	...
	{ 0, &asn_PER_type_controlResourceSetToAddModList_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_controlResourceSetToReleaseList_4 = {
	...
	{ 0, &asn_PER_type_controlResourceSetToReleaseList_constr_4, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_searchSpacesToAddModList_6 = {
	...
	{ 0, &asn_PER_type_searchSpacesToAddModList_constr_6, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_searchSpacesToReleaseList_8 = {
	...
	{ 0, &asn_PER_type_searchSpacesToReleaseList_constr_8, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_PDCCH_Config_1[] = {
	{ ATF_POINTER, 8, offsetof(struct PDCCH_Config, controlResourceSetToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_controlResourceSetToAddModList_constr_2,  memb_controlResourceSetToAddModList_constraint_1 },
		0, 0, /* No default value */
		"controlResourceSetToAddModList"
		},
	{ ATF_POINTER, 7, offsetof(struct PDCCH_Config, controlResourceSetToReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_controlResourceSetToReleaseList_constr_4,  memb_controlResourceSetToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"controlResourceSetToReleaseList"
		},
	{ ATF_POINTER, 6, offsetof(struct PDCCH_Config, searchSpacesToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_searchSpacesToAddModList_constr_6,  memb_searchSpacesToAddModList_constraint_1 },
		0, 0, /* No default value */
		"searchSpacesToAddModList"
		},
	{ ATF_POINTER, 5, offsetof(struct PDCCH_Config, searchSpacesToReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_searchSpacesToReleaseList_constr_8,  memb_searchSpacesToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"searchSpacesToReleaseList"
		},
	{ ATF_POINTER, 4, offsetof(struct PDCCH_Config, downlinkPreemption),
		...
		&asn_DEF_SetupRelease_DownlinkPreemption,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"downlinkPreemption"
	...
	{ ATF_POINTER, 3, offsetof(struct PDCCH_Config, tpc_PUSCH),
		...
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_PUSCH_TPC_CommandConfig,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"tpc-PUSCH"
	...
	{ ATF_POINTER, 2, offsetof(struct PDCCH_Config, tpc_PUCCH),
		...
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_PUCCH_TPC_CommandConfig,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"tpc-PUCCH"
	...
	{ ATF_POINTER, 1, offsetof(struct PDCCH_Config, tpc_SRS),
		...
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_SRS_TPC_CommandConfig,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"tpc-SRS"
