...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_POINTER, 0, offsetof(struct RRCSystemInfoRequest__criticalExtensions, rrcSystemInfoRequest_r15),
	...
	{ ATF_POINTER, 0, offsetof(struct RRCSystemInfoRequest__criticalExtensions, criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
