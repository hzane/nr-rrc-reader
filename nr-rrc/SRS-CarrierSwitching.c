...
asn_TYPE_descriptor_t asn_DEF_srs_SwitchFromCarrier_3 = {
	...
	{ 0, &asn_PER_type_srs_SwitchFromCarrier_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_typeA_7 = {
	...
	{ 0, &asn_PER_type_typeA_constr_7, SEQUENCE_OF_constraint },
	asn_MBR_typeA_7,
	1,	/* Single element */
...
static asn_TYPE_member_t asn_MBR_srs_TPC_PDCCH_Group_6[] = {
	{ ATF_POINTER, 0, offsetof(struct SRS_CarrierSwitching__srs_TPC_PDCCH_Group, typeA),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_typeA_7,
		0,
		{ 0, &asn_PER_memb_typeA_constr_7,  memb_typeA_constraint_6 },
		0, 0, /* No default value */
		"typeA"
		},
	{ ATF_POINTER, 0, offsetof(struct SRS_CarrierSwitching__srs_TPC_PDCCH_Group, typeB),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
...
asn_TYPE_descriptor_t asn_DEF_srs_TPC_PDCCH_Group_6 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_srs_TPC_PDCCH_Group_constr_6, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_monitoringCells_10 = {
	...
	{ 0, &asn_PER_type_monitoringCells_constr_10, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_SRS_CarrierSwitching_1[] = {
	{ ATF_POINTER, 1, offsetof(struct SRS_CarrierSwitching, srs_SwitchFromServCellIndex),
		...
		0,
		{ 0, &asn_PER_memb_srs_SwitchFromServCellIndex_constr_2,  memb_srs_SwitchFromServCellIndex_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct SRS_CarrierSwitching, monitoringCells),
		...
		0,
		{ 0, &asn_PER_memb_monitoringCells_constr_10,  memb_monitoringCells_constraint_1 },
		0, 0, /* No default value */
		"monitoringCells"
		},
};
