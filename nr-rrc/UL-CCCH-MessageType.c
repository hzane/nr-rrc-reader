...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType__c1, rrcSetupRequest),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType__c1, rrcResumeRequest),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType__c1, rrcReestablishmentRequest),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType__c1, rrcSystemInfoRequest),
...
asn_TYPE_member_t asn_MBR_UL_CCCH_MessageType_1[] = {
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType, c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType, messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
