...
asn_TYPE_member_t asn_MBR_RAN_NotificationAreaInfo_1[] = {
	{ ATF_POINTER, 0, offsetof(struct RAN_NotificationAreaInfo, cellList),
	...
	{ ATF_POINTER, 0, offsetof(struct RAN_NotificationAreaInfo, ran_AreaConfigList),
...
asn_TYPE_descriptor_t asn_DEF_RAN_NotificationAreaInfo = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_RAN_NotificationAreaInfo_constr_1, CHOICE_constraint },
