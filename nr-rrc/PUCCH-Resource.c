...
asn_TYPE_descriptor_t asn_DEF_intraSlotFrequencyHopping_4 = {
	...
	{ 0, &asn_PER_type_intraSlotFrequencyHopping_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_intraSlotFrequencyHopping_specs_4	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_format_7[] = {
	{ ATF_POINTER, 0, offsetof(struct PUCCH_Resource__format, format0),
	...
	{ ATF_POINTER, 0, offsetof(struct PUCCH_Resource__format, format1),
	...
	{ ATF_POINTER, 0, offsetof(struct PUCCH_Resource__format, format2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 0, offsetof(struct PUCCH_Resource__format, format3),
	...
	{ ATF_POINTER, 0, offsetof(struct PUCCH_Resource__format, format4),
...
asn_TYPE_descriptor_t asn_DEF_format_7 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_format_constr_7, CHOICE_constraint },
	asn_MBR_format_7,
	5,	/* Elements count */
