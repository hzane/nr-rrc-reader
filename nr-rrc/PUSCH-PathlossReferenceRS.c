...
static asn_TYPE_member_t asn_MBR_referenceSignal_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PUSCH_PathlossReferenceRS__referenceSignal, ssb_Index),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUSCH_PathlossReferenceRS__referenceSignal, csi_RS_Index),
