...
asn_TYPE_descriptor_t asn_DEF_tag_ToReleaseList_2 = {
	...
	{ 0, &asn_PER_type_tag_ToReleaseList_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_tag_ToAddModList_4 = {
	...
	{ 0, &asn_PER_type_tag_ToAddModList_constr_4, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_TAG_Config_1[] = {
	{ ATF_POINTER, 2, offsetof(struct TAG_Config, tag_ToReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_tag_ToReleaseList_constr_2,  memb_tag_ToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"tag-ToReleaseList"
		},
	{ ATF_POINTER, 1, offsetof(struct TAG_Config, tag_ToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_tag_ToAddModList_constr_4,  memb_tag_ToAddModList_constraint_1 },
		0, 0, /* No default value */
		"tag-ToAddModList"
		},
};
