...
asn_TYPE_descriptor_t asn_DEF_nzp_CSI_RS_Resources_3 = {
	...
	{ 0, &asn_PER_type_nzp_CSI_RS_Resources_constr_3, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_repetition_5 = {
	...
	{ 0, &asn_PER_type_repetition_constr_5, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_trs_Info_9 = {
	...
	{ 0, &asn_PER_type_trs_Info_constr_9, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_NZP_CSI_RS_ResourceSet_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NZP_CSI_RS_ResourceSet, nzp_CSI_RS_Resources),
		...
		0,
		{ 0, &asn_PER_memb_nzp_CSI_RS_Resources_constr_3,  memb_nzp_CSI_RS_Resources_constraint_1 },
		0, 0, /* No default value */
		"nzp-CSI-RS-Resources"
		},
	...
	{ ATF_POINTER, 2, offsetof(struct NZP_CSI_RS_ResourceSet, aperiodicTriggeringOffset),
		...
		0,
		{ 0, &asn_PER_memb_aperiodicTriggeringOffset_constr_8,  memb_aperiodicTriggeringOffset_constraint_1 },
		0, 0, /* No default value */
