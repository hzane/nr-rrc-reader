...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct DL_DCCH_MessageType__c1, rrcReconfiguration),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_DCCH_MessageType__c1, rrcResume),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_DCCH_MessageType__c1, rrcRelease),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_DCCH_MessageType__c1, rrcReestablishment),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_DCCH_MessageType__c1, securityModeCommand),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_DCCH_MessageType__c1, dlInformationTransfer),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_DCCH_MessageType__c1, ueCapabilityEnquiry),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_DCCH_MessageType__c1, counterCheck),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_DCCH_MessageType__c1, mobilityFromNRCommand),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType__c1, spare7),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType__c1, spare6),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType__c1, spare5),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType__c1, spare4),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType__c1, spare3),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType__c1, spare2),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType__c1, spare1),
...
asn_TYPE_member_t asn_MBR_DL_DCCH_MessageType_1[] = {
	{ ATF_POINTER, 0, offsetof(struct DL_DCCH_MessageType, c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_DCCH_MessageType, messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
