...
asn_TYPE_member_t asn_MBR_RLC_Config_1[] = {
	{ ATF_POINTER, 0, offsetof(struct RLC_Config, am),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_am_2,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct RLC_Config, um_Bi_Directional),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct RLC_Config, um_Uni_Directional_UL),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct RLC_Config, um_Uni_Directional_DL),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
