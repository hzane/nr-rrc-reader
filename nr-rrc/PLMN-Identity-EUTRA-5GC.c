...
asn_TYPE_member_t asn_MBR_PLMN_Identity_EUTRA_5GC_1[] = {
	{ ATF_POINTER, 0, offsetof(struct PLMN_Identity_EUTRA_5GC, plmn_Identity_EUTRA_5GC),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PLMN_Identity_EUTRA_5GC, plmn_index),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_plmn_index_constr_3,  memb_plmn_index_constraint_1 },
		0, 0, /* No default value */
		"plmn-index"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_PLMN_Identity_EUTRA_5GC = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_PLMN_Identity_EUTRA_5GC_constr_1, CHOICE_constraint },
