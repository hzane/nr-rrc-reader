...
static asn_TYPE_member_t asn_MBR_c1_3[] = {
	{ ATF_POINTER, 0, offsetof(struct HandoverCommand__criticalExtensions__c1, handoverCommand),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HandoverCommand__criticalExtensions__c1, spare3),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HandoverCommand__criticalExtensions__c1, spare2),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HandoverCommand__criticalExtensions__c1, spare1),
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_POINTER, 0, offsetof(struct HandoverCommand__criticalExtensions, c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct HandoverCommand__criticalExtensions, criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
