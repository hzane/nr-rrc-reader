...
static asn_TYPE_member_t asn_MBR_reportType_2[] = {
	{ ATF_POINTER, 0, offsetof(struct ReportConfigInterRAT__reportType, periodical),
	...
	{ ATF_POINTER, 0, offsetof(struct ReportConfigInterRAT__reportType, eventTriggered),
	...
	{ ATF_POINTER, 0, offsetof(struct ReportConfigInterRAT__reportType, reportCGI),
	...
	{ ATF_POINTER, 0, offsetof(struct ReportConfigInterRAT__reportType, reportSFTD),
