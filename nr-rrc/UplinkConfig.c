...
static int
memb_uplinkChannelBW_PerSCS_List_constraint_11(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_type_uplinkChannelBW_PerSCS_List_constr_13 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  5 }	/* (SIZE(1..5)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_uplinkChannelBW_PerSCS_List_constr_13 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  5 }	/* (SIZE(1..5)) */,
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_uplinkBWP_ToReleaseList_3 = {
	...
	{ 0, &asn_PER_type_uplinkBWP_ToReleaseList_constr_3, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_uplinkBWP_ToAddModList_5 = {
	...
	{ 0, &asn_PER_type_uplinkBWP_ToAddModList_constr_5, SEQUENCE_OF_constraint },
	asn_MBR_uplinkBWP_ToAddModList_5,
	1,	/* Single element */
	&asn_SPC_uplinkBWP_ToAddModList_specs_5	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_uplinkChannelBW_PerSCS_List_13[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_uplinkChannelBW_PerSCS_List_tags_13[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_uplinkChannelBW_PerSCS_List_specs_13 = {
...
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_uplinkChannelBW_PerSCS_List_13 = {
	"uplinkChannelBW-PerSCS-List",
	"uplinkChannelBW-PerSCS-List",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_uplinkChannelBW_PerSCS_List_tags_13,
	sizeof(asn_DEF_uplinkChannelBW_PerSCS_List_tags_13)
		/sizeof(asn_DEF_uplinkChannelBW_PerSCS_List_tags_13[0]) - 1, /* 1 */
	asn_DEF_uplinkChannelBW_PerSCS_List_tags_13,	/* Same as above */
	sizeof(asn_DEF_uplinkChannelBW_PerSCS_List_tags_13)
		/sizeof(asn_DEF_uplinkChannelBW_PerSCS_List_tags_13[0]), /* 2 */
	{ 0, &asn_PER_type_uplinkChannelBW_PerSCS_List_constr_13, SEQUENCE_OF_constraint },
	asn_MBR_uplinkChannelBW_PerSCS_List_13,
	1,	/* Single element */
	&asn_SPC_uplinkChannelBW_PerSCS_List_specs_13	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_ext1_11[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct UplinkConfig__ext1, uplinkChannelBW_PerSCS_List),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_uplinkChannelBW_PerSCS_List_13,
		0,
		{ 0, &asn_PER_memb_uplinkChannelBW_PerSCS_List_constr_13,  memb_uplinkChannelBW_PerSCS_List_constraint_11 },
		0, 0, /* No default value */
		"uplinkChannelBW-PerSCS-List"
		},
};
...
asn_TYPE_member_t asn_MBR_UplinkConfig_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct UplinkConfig, uplinkBWP_ToReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_uplinkBWP_ToReleaseList_constr_3,  memb_uplinkBWP_ToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"uplinkBWP-ToReleaseList"
		},
	{ ATF_POINTER, 5, offsetof(struct UplinkConfig, uplinkBWP_ToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_uplinkBWP_ToAddModList_constr_5,  memb_uplinkBWP_ToAddModList_constraint_1 },
		0, 0, /* No default value */
		"uplinkBWP-ToAddModList"
		},
