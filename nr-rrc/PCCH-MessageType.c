...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct PCCH_MessageType__c1, paging),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PCCH_MessageType__c1, spare1),
...
asn_TYPE_member_t asn_MBR_PCCH_MessageType_1[] = {
	{ ATF_POINTER, 0, offsetof(struct PCCH_MessageType, c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct PCCH_MessageType, messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
