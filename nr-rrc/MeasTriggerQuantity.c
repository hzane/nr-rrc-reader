...
asn_TYPE_member_t asn_MBR_MeasTriggerQuantity_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MeasTriggerQuantity, rsrp),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasTriggerQuantity, rsrq),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasTriggerQuantity, sinr),
...
asn_TYPE_descriptor_t asn_DEF_MeasTriggerQuantity = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_MeasTriggerQuantity_constr_1, CHOICE_constraint },
