...
static asn_TYPE_member_t asn_MBR_eventId_2[] = {
	{ ATF_POINTER, 0, offsetof(struct EventTriggerConfigInterRAT__eventId, eventB1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_eventB1_3,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct EventTriggerConfigInterRAT__eventId, eventB2),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_eventB2_9,
		0,
...
asn_TYPE_descriptor_t asn_DEF_reportAmount_19 = {
	...
	{ 0, &asn_PER_type_reportAmount_constr_19, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_EventTriggerConfigInterRAT_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EventTriggerConfigInterRAT, maxReportCells),
		...
		0,
		{ 0, &asn_PER_memb_maxReportCells_constr_29,  memb_maxReportCells_constraint_1 },
		0, 0, /* No default value */
		"maxReportCells"
		},
};
