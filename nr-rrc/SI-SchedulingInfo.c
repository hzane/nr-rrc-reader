...
asn_TYPE_descriptor_t asn_DEF_schedulingInfoList_2 = {
	...
	{ 0, &asn_PER_type_schedulingInfoList_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_si_WindowLength_4 = {
	...
	{ 0, &asn_PER_type_si_WindowLength_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SI_SchedulingInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SI_SchedulingInfo, schedulingInfoList),
		...
		0,
		{ 0, &asn_PER_memb_schedulingInfoList_constr_2,  memb_schedulingInfoList_constraint_1 },
		0, 0, /* No default value */
		"schedulingInfoList"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct SI_SchedulingInfo, systemInformationAreaID),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_systemInformationAreaID_constr_16,  memb_systemInformationAreaID_constraint_1 },
		0, 0, /* No default value */
