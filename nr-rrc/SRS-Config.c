...
asn_TYPE_descriptor_t asn_DEF_srs_ResourceSetToReleaseList_2 = {
	...
	{ 0, &asn_PER_type_srs_ResourceSetToReleaseList_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_srs_ResourceSetToAddModList_4 = {
	...
	{ 0, &asn_PER_type_srs_ResourceSetToAddModList_constr_4, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_srs_ResourceToReleaseList_6 = {
	...
	{ 0, &asn_PER_type_srs_ResourceToReleaseList_constr_6, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_srs_ResourceToAddModList_8 = {
	...
	{ 0, &asn_PER_type_srs_ResourceToAddModList_constr_8, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_tpc_Accumulation_10 = {
	...
	{ 0, &asn_PER_type_tpc_Accumulation_constr_10, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SRS_Config_1[] = {
	{ ATF_POINTER, 5, offsetof(struct SRS_Config, srs_ResourceSetToReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_srs_ResourceSetToReleaseList_constr_2,  memb_srs_ResourceSetToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"srs-ResourceSetToReleaseList"
		},
	{ ATF_POINTER, 4, offsetof(struct SRS_Config, srs_ResourceSetToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_srs_ResourceSetToAddModList_constr_4,  memb_srs_ResourceSetToAddModList_constraint_1 },
		0, 0, /* No default value */
		"srs-ResourceSetToAddModList"
		},
	{ ATF_POINTER, 3, offsetof(struct SRS_Config, srs_ResourceToReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_srs_ResourceToReleaseList_constr_6,  memb_srs_ResourceToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"srs-ResourceToReleaseList"
		},
	{ ATF_POINTER, 2, offsetof(struct SRS_Config, srs_ResourceToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_srs_ResourceToAddModList_constr_8,  memb_srs_ResourceToAddModList_constraint_1 },
		0, 0, /* No default value */
		"srs-ResourceToAddModList"
		},
