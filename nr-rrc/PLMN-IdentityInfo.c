...
asn_TYPE_descriptor_t asn_DEF_plmn_IdentityList_2 = {
	...
	{ 0, &asn_PER_type_plmn_IdentityList_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_cellReservedForOperatorUse_7 = {
	...
	{ 0, &asn_PER_type_cellReservedForOperatorUse_constr_7, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_PLMN_IdentityInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PLMN_IdentityInfo, plmn_IdentityList),
		...
		0,
		{ 0, &asn_PER_memb_plmn_IdentityList_constr_2,  memb_plmn_IdentityList_constraint_1 },
		0, 0, /* No default value */
		"plmn-IdentityList"
		},
