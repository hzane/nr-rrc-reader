...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct BCCH_DL_SCH_MessageType__c1, systemInformation),
	...
	{ ATF_POINTER, 0, offsetof(struct BCCH_DL_SCH_MessageType__c1, systemInformationBlockType1),
...
asn_TYPE_member_t asn_MBR_BCCH_DL_SCH_MessageType_1[] = {
	{ ATF_POINTER, 0, offsetof(struct BCCH_DL_SCH_MessageType, c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct BCCH_DL_SCH_MessageType, messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
