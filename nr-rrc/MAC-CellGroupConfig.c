...
static asn_TYPE_member_t asn_MBR_ext1_9[] = {
	{ ATF_POINTER, 2, offsetof(struct MAC_CellGroupConfig__ext1, csi_Mask),
	...
	{ ATF_POINTER, 1, offsetof(struct MAC_CellGroupConfig__ext1, dataInactivityTimer),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_DataInactivityTimer,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"dataInactivityTimer"
...
asn_TYPE_member_t asn_MBR_MAC_CellGroupConfig_1[] = {
	{ ATF_POINTER, 5, offsetof(struct MAC_CellGroupConfig, drx_Config),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_DRX_Config,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"drx-Config"
	...
	{ ATF_POINTER, 1, offsetof(struct MAC_CellGroupConfig, phr_Config),
		...
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_PHR_Config,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"phr-Config"
