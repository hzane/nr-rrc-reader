...
static asn_TYPE_member_t asn_MBR_servedRadioBearer_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RLC_BearerConfig__servedRadioBearer, srb_Identity),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RLC_BearerConfig__servedRadioBearer, drb_Identity),
...
asn_TYPE_descriptor_t asn_DEF_servedRadioBearer_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_servedRadioBearer_constr_3, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_reestablishRLC_6 = {
	...
	{ 0, &asn_PER_type_reestablishRLC_constr_6, NativeEnumerated_constraint },
