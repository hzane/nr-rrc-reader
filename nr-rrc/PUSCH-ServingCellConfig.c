...
static asn_oer_constraints_t asn_OER_memb_maxMIMO_Layers_constr_11 CC_NOTUSED = {
	{ 1, 1 }	/* (1..4) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_ext1_10[] = {
	{ ATF_POINTER, 2, offsetof(struct PUSCH_ServingCellConfig__ext1, maxMIMO_Layers),
		...
		0,
		{ &asn_OER_memb_maxMIMO_Layers_constr_11, &asn_PER_memb_maxMIMO_Layers_constr_11,  memb_maxMIMO_Layers_constraint_10 },
