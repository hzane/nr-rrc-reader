 ...
 */
static int
memb_maxMIMO_Layers_constraint_10(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_maxMIMO_Layers_constr_11 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_rateMatching_3 = {
	...
	{ 0, &asn_PER_type_rateMatching_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_xOverhead_5 = {
	...
	{ 0, &asn_PER_type_xOverhead_constr_5, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_ext1_10[] = {
	{ ATF_POINTER, 2, offsetof(struct PUSCH_ServingCellConfig__ext1, maxMIMO_Layers),
		...
		0,
		{ 0, &asn_PER_memb_maxMIMO_Layers_constr_11,  memb_maxMIMO_Layers_constraint_10 },
