...
asn_TYPE_descriptor_t asn_DEF_uac_BarringFactor_2 = {
	...
	{ 0, &asn_PER_type_uac_BarringFactor_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_uac_BarringTime_19 = {
	...
	{ 0, &asn_PER_type_uac_BarringTime_constr_19, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_UAC_BarringInfoSet_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UAC_BarringInfoSet, uac_BarringForAccessIdentity),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_uac_BarringForAccessIdentity_constr_28,  memb_uac_BarringForAccessIdentity_constraint_1 },
		0, 0, /* No default value */
