...
static asn_TYPE_member_t asn_MBR_eventId_2[] = {
	{ ATF_POINTER, 0, offsetof(struct EventTriggerConfig__eventId, eventA1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_eventA1_3,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct EventTriggerConfig__eventId, eventA2),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_eventA2_8,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct EventTriggerConfig__eventId, eventA3),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_eventA3_13,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct EventTriggerConfig__eventId, eventA4),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_eventA4_19,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct EventTriggerConfig__eventId, eventA5),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_eventA5_25,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct EventTriggerConfig__eventId, eventA6),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_eventA6_32,
		0,
...
asn_TYPE_descriptor_t asn_DEF_eventId_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_eventId_constr_2, CHOICE_constraint },
	asn_MBR_eventId_2,
	6,	/* Elements count */
...
asn_TYPE_descriptor_t asn_DEF_reportAmount_41 = {
	...
	{ 0, &asn_PER_type_reportAmount_constr_41, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_reportAddNeighMeas_55 = {
	...
	{ 0, &asn_PER_type_reportAddNeighMeas_constr_55, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_EventTriggerConfig_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EventTriggerConfig, maxReportCells),
		...
		0,
		{ 0, &asn_PER_memb_maxReportCells_constr_51,  memb_maxReportCells_constraint_1 },
		0, 0, /* No default value */
		"maxReportCells"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct EventTriggerConfig, maxNrofRS_IndexesToReport),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNrofRS_IndexesToReport_constr_53,  memb_maxNrofRS_IndexesToReport_constraint_1 },
		0, 0, /* No default value */
