...
asn_TYPE_descriptor_t asn_DEF_mfbi_EUTRA_2 = {
	...
	{ 0, &asn_PER_type_mfbi_EUTRA_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_multiNS_Pmax_EUTRA_5 = {
	...
	{ 0, &asn_PER_type_multiNS_Pmax_EUTRA_constr_5, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_rs_SINR_MeasEUTRA_7 = {
	...
	{ 0, &asn_PER_type_rs_SINR_MeasEUTRA_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_ne_DC_11 = {
	...
	{ 0, &asn_PER_type_ne_DC_constr_11, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_EUTRA_ParametersCommon_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_ParametersCommon, modifiedMPR_BehaviorEUTRA),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_modifiedMPR_BehaviorEUTRA_constr_4,  memb_modifiedMPR_BehaviorEUTRA_constraint_1 },
		0, 0, /* No default value */
