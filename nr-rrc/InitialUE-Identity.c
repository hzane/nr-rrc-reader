...
asn_TYPE_member_t asn_MBR_InitialUE_Identity_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct InitialUE_Identity, ng_5G_S_TMSI_Part1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ng_5G_S_TMSI_Part1_constr_2,  memb_ng_5G_S_TMSI_Part1_constraint_1 },
		0, 0, /* No default value */
		"ng-5G-S-TMSI-Part1"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct InitialUE_Identity, randomValue),
