...
asn_TYPE_descriptor_t asn_DEF_timeFrequencySet_3 = {
	...
	{ 0, &asn_PER_type_timeFrequencySet_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_int_ConfigurationPerServingCell_7 = {
	...
	{ 0, &asn_PER_type_int_ConfigurationPerServingCell_constr_7, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_DownlinkPreemption_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DownlinkPreemption, dci_PayloadSize),
		...
		0,
		{ 0, &asn_PER_memb_dci_PayloadSize_constr_6,  memb_dci_PayloadSize_constraint_1 },
		0, 0, /* No default value */
		"dci-PayloadSize"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct DownlinkPreemption, int_ConfigurationPerServingCell),
		...
		0,
		{ 0, &asn_PER_memb_int_ConfigurationPerServingCell_constr_7,  memb_int_ConfigurationPerServingCell_constraint_1 },
		0, 0, /* No default value */
		"int-ConfigurationPerServingCell"
		},
};
