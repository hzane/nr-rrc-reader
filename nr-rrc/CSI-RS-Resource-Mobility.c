...
static asn_TYPE_member_t asn_MBR_slotConfig_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_Resource_Mobility__slotConfig, ms4),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ms4_constr_4,  memb_ms4_constraint_3 },
		0, 0, /* No default value */
		"ms4"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_Resource_Mobility__slotConfig, ms5),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ms5_constr_5,  memb_ms5_constraint_3 },
		0, 0, /* No default value */
		"ms5"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_Resource_Mobility__slotConfig, ms10),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ms10_constr_6,  memb_ms10_constraint_3 },
		0, 0, /* No default value */
		"ms10"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_Resource_Mobility__slotConfig, ms20),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ms20_constr_7,  memb_ms20_constraint_3 },
		0, 0, /* No default value */
		"ms20"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_Resource_Mobility__slotConfig, ms40),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ms40_constr_8,  memb_ms40_constraint_3 },
		0, 0, /* No default value */
		"ms40"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_slotConfig_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_slotConfig_constr_3, CHOICE_constraint },
...
static asn_TYPE_member_t asn_MBR_frequencyDomainAllocation_12[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_Resource_Mobility__frequencyDomainAllocation, row1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_row1_constr_13,  memb_row1_constraint_12 },
		0, 0, /* No default value */
		"row1"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_Resource_Mobility__frequencyDomainAllocation, row2),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_row2_constr_14,  memb_row2_constraint_12 },
		0, 0, /* No default value */
		"row2"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_frequencyDomainAllocation_12 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_frequencyDomainAllocation_constr_12, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_CSI_RS_Resource_Mobility_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_Resource_Mobility, firstOFDMSymbolInTimeDomain),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_firstOFDMSymbolInTimeDomain_constr_15,  memb_firstOFDMSymbolInTimeDomain_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_Resource_Mobility, sequenceGenerationConfig),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_sequenceGenerationConfig_constr_16,  memb_sequenceGenerationConfig_constraint_1 },
		0, 0, /* No default value */
