...
static asn_TYPE_member_t asn_MBR_periodicityAndOffset_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SSB_MTC__periodicityAndOffset, sf5),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SSB_MTC__periodicityAndOffset, sf10),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SSB_MTC__periodicityAndOffset, sf20),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SSB_MTC__periodicityAndOffset, sf40),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SSB_MTC__periodicityAndOffset, sf80),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SSB_MTC__periodicityAndOffset, sf160),
